...
- **<code>&nbsp;12602</code>** [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).
...
- **<code>&nbsp;13676</code>** [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
...
- **<code>&nbsp;&nbsp;8776</code>** [sqlc](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
...
- **<code>&nbsp;&nbsp;5088</code>** [go-elasticsearch](https://github.com/elastic/go-elasticsearch) - Official Elasticsearch client for Go.
...
- **<code>106294</code>** [pjrpc](https://gitlab.com/pjrpc/pjrpc) - Golang JSON-RPC Server-Client with Protobuf spec.
...
- **<code>&nbsp;&nbsp;3243</code>** [gio](https://gioui.org) - Gio is a library for writing cross-platform immediate mode GUI-s in Go. Gio supports all the major platforms: Linux, macOS, Windows, Android, iOS, FreeBSD, OpenBSD and WebAssembly.
...
- **<code>&nbsp;&nbsp;3782</code>** [gocron](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
...
- **<code>&nbsp;&nbsp;4192</code>** [lumberjack](https://github.com/natefinch/lumberjack) - Simple rolling logger, implements io.WriteCloser.
...
- **<code>&nbsp;&nbsp;&nbsp;255</code>** [tint](https://github.com/lmittmann/tint) - A slog.Handler that writes tinted logs.
...
- **<code>106294</code>** [go-formatter](https://gitlab.com/tymonx/go-formatter) - Implements **replacement fields** surrounded by curly braces `{}` format strings.
...
- **<code>&nbsp;&nbsp;2195</code>** [gojieba](https://github.com/yanyiwu/gojieba) - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.
...
- **<code>&nbsp;&nbsp;2904</code>** [XORM](https://gitea.com/xorm/xorm) - Simple and powerful ORM for Go. (Support: MySQL, MyMysql, PostgreSQL, Tidb, SQLite3, MsSql and Oracle).
...
- **<code>113538</code>** [go modules](https://golang.org/cmd/go/#hdr-Modules__module_versions__and_more) - Modules are the unit of source code interchange and versioning. The go command has direct support for working with modules, including recording and resolving dependencies on other modules.
...
- **<code>113538</code>** [autocert](https://godoc.org/golang.org/x/crypto/acme/autocert) - Auto provision Let's Encrypt certificates and start a TLS server.
...
- **<code>&nbsp;48555</code>** [Caddy](https://github.com/caddyserver/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
...
- **<code>&nbsp;23692</code>** [nsq](https://nsq.io/) - A realtime distributed messaging platform.
...
- **<code>&nbsp;&nbsp;2693</code>** [flipt](https://github.com/markphelps/flipt) - A self contained feature flag solution written in Go and Vue.js
...
- Testing Frameworks
  ...
  - **<code>113538</code>** [testmd](https://godoc.org/github.com/tvastar/test/cmd/testmd) - Convert markdown snippets into testable go code.
  ...
  - **<code>&nbsp;&nbsp;&nbsp;662</code>** [apitest](https://apitest.dev) - Simple and extensible behavioural testing library for REST based services or HTTP handlers that supports mocking external http calls and rendering of sequence diagrams.
...
- Mock
  ...
  - **<code>106294</code>** [genmock](https://gitlab.com/so_literate/genmock) - Go mocking system with code generator for building calls of the interface methods.
...
- **<code>113538</code>** [github_flavored_markdown](https://godoc.org/github.com/shurcooL/github_flavored_markdown) - GitHub Flavored Markdown renderer (using blackfriday) with fenced code block highlighting, clickable header anchor links.
...
- **<code>&nbsp;12802</code>** [lo](https://github.com/samber/lo) - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- **<code>106294</code>** [cli](https://gitlab.com/gitlab-org/cli) - An open-source GitLab command line tool bringing GitLab's cool features to your command line.
...
- **<code>113538</code>** [goimports](https://godoc.org/golang.org/x/tools/cmd/goimports) - Tool to fix (add, remove) your Go imports automatically.
...
- **<code>&nbsp;44177</code>** [traefik](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.
- **<code>&nbsp;42755</code>** [Gogs](https://gogs.io/) - A Self Hosted Git Service in the Go Programming Language.
- **<code>&nbsp;37858</code>** [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.
- **<code>&nbsp;37858</code>** [gitea-github-migrator](https://git.jonasfranz.software/JonasFranzDEV/gitea-github-migrator) - Migrate all your GitHub repositories, issues, milestones and labels to your Gitea instance.
...
- **<code>&nbsp;68513</code>** [hugo](https://gohugo.io/) - Fast and Modern Static Website Engine.
...
- **<code>&nbsp;20908</code>** [restic](https://github.com/restic/restic) - De-duplicating backup program.
...
- **<code>&nbsp;&nbsp;2844</code>** [zs](https://git.mills.io/prologic/zs) - an extremely minimal static site generator.
...
- **<code>&nbsp;&nbsp;1322</code>** [Docker](https://www.docker.com/) - Open platform for distributed applications for developers and sysadmins.
...
- **<code>&nbsp;&nbsp;5225</code>** [100 Go Mistakes: How to Avoid Them](https://www.manning.com/books/100-go-mistakes-how-to-avoid-them)
...
- **<code>&nbsp;15618</code>** [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
...
- **<code>113538</code>** [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- **<code>&nbsp;27590</code>** [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md)
- **<code>&nbsp;14751</code>** [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst)
- **<code>&nbsp;14136</code>** [Uber](https://github.com/uber-go/guide/blob/master/style.md)
- **<code>&nbsp;11993</code>** [Thanos](https://thanos.io/tip/contributing/coding-style-guide.md/)
- **<code>&nbsp;&nbsp;8720</code>** [Sourcegraph](https://docs.sourcegraph.com/dev/background-information/languages/go)
...
- **<code>113538</code>** [godoc.org](https://godoc.org/) - Documentation for open source Go packages.
- **<code>113538</code>** [go.dev](https://go.dev/) - A hub for Go developers.
- **<code>113538</code>** [Go Projects](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
- **<code>113538</code>** [Go Blog](https://blog.golang.org) - The official Go blog.
- **<code>113538</code>** [Go Proverbs](https://go-proverbs.github.io/) - Go Proverbs by Rob Pike.
...
- **<code>&nbsp;&nbsp;7000</code>** [Explore Go Libraries & Projects](https://kandi.openweaver.com/explore/go) - Discover & find a curated list of popular & new Go libraries, top authors, trending project kits, discussions, tutorials & learning resources on kandi.
...
- **<code>113538</code>** [A Comprehensive Guide to Structured Logging in Go](https://betterstack.com/community/guides/logging/logging-in-go/) - Delve deep into the world of structured logging in Go with a specific focus on recently accepted slog proposal which aims to bring high performance structured logging with levels to the standard library.
...
- **<code>113538</code>** [Go WebAssembly Tutorial - Building a Simple Calculator](https://tutorialedge.net/golang/go-webassembly-tutorial/)
- **<code>&nbsp;70722</code>** [Building Go Web Applications and Microservices Using Gin](https://semaphoreci.com/community/tutorials/building-go-web-applications-and-microservices-using-gin) - Get familiar with Gin and find out how it can help you reduce boilerplate code and build a request handling pipeline.
...
- **<code>&nbsp;19923</code>** [Golang Tutorial Guide](https://www.freecodecamp.org/news/golang-tutorial-list-free-courses-learn-go-programming-language/) - A List of Free Courses to Learn the Go Programming Language.
...
- **<code>&nbsp;&nbsp;6414</code>** [Go By Example](https://gobyexample.com/) - Hands-on introduction to Go using annotated example programs.
...
- **<code>246828</code>** [The Go Developer Roadmap](https://roadmap.sh/golang) - A visual roadmap that new Go developers can follow through to help them learn Go.
