...
- **<code>&nbsp;12603</code>** [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).
- **<code>&nbsp;&nbsp;9321</code>** [gocui](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.
- **<code>&nbsp;&nbsp;6099</code>** [lipgloss](https://github.com/charmbracelet/lipgloss) - Declaratively define styles for color, format and layout in the terminal.
- **<code>&nbsp;&nbsp;4978</code>** [go-prompt](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
- **<code>&nbsp;&nbsp;2906</code>** [woodpecker](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
...
- **<code>&nbsp;49457</code>** [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
...
- **<code>&nbsp;27593</code>** [cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
- **<code>&nbsp;25955</code>** [influxdb](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.
- **<code>&nbsp;22096</code>** [Milvus](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
...
- **<code>&nbsp;13930</code>** [rqlite](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
...
- **<code>&nbsp;12611</code>** [badger](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
...
- **<code>&nbsp;&nbsp;5808</code>** [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go.
...
- **<code>&nbsp;12002</code>** [migrate](https://github.com/golang-migrate/migrate) - Database migrations. CLI and Golang library.
...
- **<code>&nbsp;&nbsp;7564</code>** [pgx](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
...
- **<code>106348</code>** [pjrpc](https://gitlab.com/pjrpc/pjrpc) - Golang JSON-RPC Server-Client with Protobuf spec.
...
- **<code>&nbsp;25165</code>** [go-zero](https://github.com/tal-tech/go-zero) - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
...
- **<code>&nbsp;&nbsp;6136</code>** [Kitex](https://github.com/cloudwego/kitex) - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
...
- **<code>&nbsp;21038</code>** [fyne](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- **<code>&nbsp;&nbsp;3245</code>** [gio](https://gioui.org) - Gio is a library for writing cross-platform immediate mode GUI-s in Go. Gio supports all the major platforms: Linux, macOS, Windows, Android, iOS, FreeBSD, OpenBSD and WebAssembly.
...
- **<code>&nbsp;&nbsp;3785</code>** [gocron](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
- **<code>&nbsp;&nbsp;1377</code>** [go-quartz](https://github.com/reugn/go-quartz) - Simple, zero-dependency scheduling library for Go.
...
- **<code>&nbsp;23085</code>** [logrus](https://github.com/Sirupsen/logrus) - Structured logger for Go.
- **<code>&nbsp;19327</code>** [zap](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
...
- **<code>&nbsp;&nbsp;7180</code>** [gorush](https://github.com/appleboy/gorush) - Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).
...
- **<code>&nbsp;&nbsp;2821</code>** [ardanlabs/service](https://github.com/ardanlabs/service) - A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications.
...
- **<code>106348</code>** [go-formatter](https://gitlab.com/tymonx/go-formatter) - Implements **replacement fields** surrounded by curly braces `{}` format strings.
...
- **<code>&nbsp;&nbsp;9335</code>** [gopsutil](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- **<code>&nbsp;19962</code>** [fasthttp](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- **<code>&nbsp;&nbsp;8530</code>** [quic-go](https://github.com/lucas-clemente/quic-go) - An implementation of the QUIC protocol in pure Go.
...
- **<code>&nbsp;&nbsp;2906</code>** [XORM](https://gitea.com/xorm/xorm) - Simple and powerful ORM for Go. (Support: MySQL, MyMysql, PostgreSQL, Tidb, SQLite3, MsSql and Oracle).
...
- **<code>113565</code>** [go modules](https://golang.org/cmd/go/#hdr-Modules__module_versions__and_more) - Modules are the unit of source code interchange and versioning. The go command has direct support for working with modules, including recording and resolving dependencies on other modules.
...
- **<code>113565</code>** [autocert](https://godoc.org/golang.org/x/crypto/acme/autocert) - Auto provision Let's Encrypt certificates and start a TLS server.
...
- **<code>&nbsp;44205</code>** [etcd](https://github.com/coreos/etcd) - Highly-available key value store for shared configuration and service discovery.
- **<code>&nbsp;40348</code>** [minio](https://github.com/minio/minio) - Minio is a distributed object storage server.
- **<code>&nbsp;23693</code>** [nsq](https://nsq.io/) - A realtime distributed messaging platform.
...
- **<code>&nbsp;&nbsp;2699</code>** [flipt](https://github.com/markphelps/flipt) - A self contained feature flag solution written in Go and Vue.js
...
- Testing Frameworks
  ...
  - **<code>113565</code>** [testmd](https://godoc.org/github.com/tvastar/test/cmd/testmd) - Convert markdown snippets into testable go code.
...
- Mock
  ...
  - **<code>106348</code>** [genmock](https://gitlab.com/so_literate/genmock) - Go mocking system with code generator for building calls of the interface methods.
...
- **<code>113565</code>** [github_flavored_markdown](https://godoc.org/github.com/shurcooL/github_flavored_markdown) - GitHub Flavored Markdown renderer (using blackfriday) with fenced code block highlighting, clickable header anchor links.
...
- **<code>&nbsp;&nbsp;6186</code>** [go-openai](https://github.com/sashabaranov/go-openai) - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- **<code>&nbsp;53746</code>** [fzf](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.
...
- **<code>&nbsp;13723</code>** [validator](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- **<code>106348</code>** [cli](https://gitlab.com/gitlab-org/cli) - An open-source GitLab command line tool bringing GitLab's cool features to your command line.
...
- **<code>&nbsp;26295</code>** [Echo](https://github.com/labstack/echo) - High performance, minimalist Go web framework.
...
- **<code>&nbsp;18965</code>** [mux](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.
...
- **<code>113565</code>** [goimports](https://godoc.org/golang.org/x/tools/cmd/goimports) - Tool to fix (add, remove) your Go imports automatically.
...
- **<code>&nbsp;15537</code>** [vim-go](https://github.com/fatih/vim-go) - Go development plugin for Vim.
...
- **<code>100852</code>** [kubernetes](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
...
- **<code>&nbsp;44193</code>** [traefik](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.
- **<code>&nbsp;42760</code>** [Gogs](https://gogs.io/) - A Self Hosted Git Service in the Go Programming Language.
- **<code>&nbsp;37869</code>** [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.
- **<code>&nbsp;37869</code>** [gitea-github-migrator](https://git.jonasfranz.software/JonasFranzDEV/gitea-github-migrator) - Migrate all your GitHub repositories, issues, milestones and labels to your Gitea instance.
- **<code>&nbsp;21654</code>** [Vegeta](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!
- **<code>&nbsp;16074</code>** [Hey](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.
...
- **<code>&nbsp;&nbsp;8700</code>** [GVM](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.
...
- **<code>&nbsp;68533</code>** [hugo](https://gohugo.io/) - Fast and Modern Static Website Engine.
...
- **<code>&nbsp;&nbsp;4726</code>** [Duplicacy](https://github.com/gilbertchen/duplicacy) - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
- **<code>&nbsp;&nbsp;2846</code>** [zs](https://git.mills.io/prologic/zs) - an extremely minimal static site generator.
...
- **<code>&nbsp;&nbsp;1323</code>** [Docker](https://www.docker.com/) - Open platform for distributed applications for developers and sysadmins.
...
- **<code>&nbsp;&nbsp;5227</code>** [100 Go Mistakes: How to Avoid Them](https://www.manning.com/books/100-go-mistakes-how-to-avoid-them)
...
- **<code>&nbsp;15624</code>** [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
...
- **<code>113565</code>** [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- **<code>&nbsp;27593</code>** [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md)
...
- **<code>&nbsp;11998</code>** [Thanos](https://thanos.io/tip/contributing/coding-style-guide.md/)
- **<code>&nbsp;&nbsp;8724</code>** [Sourcegraph](https://docs.sourcegraph.com/dev/background-information/languages/go)
...
- **<code>113565</code>** [godoc.org](https://godoc.org/) - Documentation for open source Go packages.
- **<code>113565</code>** [go.dev](https://go.dev/) - A hub for Go developers.
- **<code>113565</code>** [Go Projects](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
- **<code>113565</code>** [Go Blog](https://blog.golang.org) - The official Go blog.
- **<code>113565</code>** [Go Proverbs](https://go-proverbs.github.io/) - Go Proverbs by Rob Pike.
...
- **<code>&nbsp;&nbsp;7001</code>** [Explore Go Libraries & Projects](https://kandi.openweaver.com/explore/go) - Discover & find a curated list of popular & new Go libraries, top authors, trending project kits, discussions, tutorials & learning resources on kandi.
...
- **<code>&nbsp;&nbsp;&nbsp;&nbsp;23</code>** [Golang News](https://golangnews.com) - Links and news about Go programming.
...
- **<code>113565</code>** [A Comprehensive Guide to Structured Logging in Go](https://betterstack.com/community/guides/logging/logging-in-go/) - Delve deep into the world of structured logging in Go with a specific focus on recently accepted slog proposal which aims to bring high performance structured logging with levels to the standard library.
...
- **<code>113565</code>** [Go WebAssembly Tutorial - Building a Simple Calculator](https://tutorialedge.net/golang/go-webassembly-tutorial/)
- **<code>&nbsp;70753</code>** [Building Go Web Applications and Microservices Using Gin](https://semaphoreci.com/community/tutorials/building-go-web-applications-and-microservices-using-gin) - Get familiar with Gin and find out how it can help you reduce boilerplate code and build a request handling pipeline.
- **<code>&nbsp;42237</code>** [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - Golang ebook intro how to build a web app with golang.
...
- **<code>&nbsp;19925</code>** [Golang Tutorial Guide](https://www.freecodecamp.org/news/golang-tutorial-list-free-courses-learn-go-programming-language/) - A List of Free Courses to Learn the Go Programming Language.
...
- **<code>&nbsp;&nbsp;6412</code>** [Go By Example](https://gobyexample.com/) - Hands-on introduction to Go using annotated example programs.
...
- **<code>&nbsp;&nbsp;&nbsp;782</code>** [Learning Go by examples](https://dev.to/aurelievache/learning-go-by-examples-introduction-448n) - Series of articles in order to learn Golang language by concrete applications as example.
...
- **<code>246881</code>** [The Go Developer Roadmap](https://roadmap.sh/golang) - A visual roadmap that new Go developers can follow through to help them learn Go.
