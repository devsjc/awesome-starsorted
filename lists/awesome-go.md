...
- **<code>&nbsp;&nbsp;&nbsp;257</code>** [flac](https://github.com/mewkiz/flac) - Native Go FLAC encoder/decoder with support for FLAC streams.
...
- **<code>&nbsp;15597</code>** [casbin](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, and ABAC.
- **<code>&nbsp;&nbsp;5190</code>** [jwt-go](https://github.com/golang-jwt/jwt) - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- **<code>&nbsp;&nbsp;4839</code>** [oauth2](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
- **<code>&nbsp;&nbsp;4294</code>** [goth](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
- **<code>&nbsp;&nbsp;4178</code>** [keto](https://github.com/ory/keto) - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
- **<code>&nbsp;&nbsp;3479</code>** [authboss](https://github.com/volatiletech/authboss) - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure it, and start building your app without having to build an authentication system each time.
...
- **<code>&nbsp;43433</code>** [go-ethereum](https://github.com/ethereum/go-ethereum) - Official Go implementation of the Ethereum protocol.
...
- **<code>&nbsp;&nbsp;5383</code>** [cosmos-sdk](https://github.com/cosmos/cosmos-sdk) - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
...
- **<code>&nbsp;&nbsp;&nbsp;340</code>** [cometbft](https://github.com/cometbft/cometbft) - A distributed, Byzantine fault-tolerant, deterministic state machine replication engine. It is a fork of Tendermint Core and implements the Tendermint consensus algorithm.
...
- **<code>&nbsp;&nbsp;4883</code>** [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - Simple and clean Telegram bot client.
...
- **<code>&nbsp;&nbsp;1400</code>** [wayback](https://github.com/wabarc/wayback) - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- **<code>&nbsp;&nbsp;&nbsp;931</code>** [Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot) - A golang implementation of a console-based trading bot for cryptocurrency exchanges.
...
- **<code>&nbsp;&nbsp;&nbsp;303</code>** [go-twitch-irc](https://github.com/gempir/go-twitch-irc) - Library to write bots for twitch.tv chat
...
- **<code>&nbsp;&nbsp;&nbsp;172</code>** [bot](https://github.com/go-telegram/bot) - Zero-dependencies Telegram Bot library with additional UI components
...
- **<code>&nbsp;&nbsp;3656</code>** [mage](https://github.com/magefile/mage) - Mage is a make/rake-like build tool using Go.
...
- **<code>&nbsp;19503</code>** [bubbletea](https://github.com/charmbracelet/bubbletea) - Go framework to build terminal apps, based on The Elm Architecture.
...
- **<code>&nbsp;&nbsp;9355</code>** [gocui](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.
- **<code>&nbsp;&nbsp;6129</code>** [lipgloss](https://github.com/charmbracelet/lipgloss) - Declaratively define styles for color, format and layout in the terminal.
- **<code>&nbsp;&nbsp;4987</code>** [go-prompt](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
- **<code>&nbsp;&nbsp;3966</code>** [pterm](https://github.com/pterm/pterm) - A library to beautify console output on every platform with many combinable components.
- **<code>&nbsp;&nbsp;3698</code>** [bubbles](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
...
- **<code>&nbsp;&nbsp;1445</code>** [termenv](https://github.com/muesli/termenv) - Advanced ANSI style & color support for your terminal applications.
...
- **<code>&nbsp;&nbsp;&nbsp;376</code>** [box-cli-maker](https://github.com/Delta456/box-cli-maker) - Make Highly Customized Boxes for your CLI.
- **<code>&nbsp;&nbsp;&nbsp;333</code>** [tabby](https://github.com/cheynewallace/tabby) - A tiny library for super simple Golang tables.
- **<code>&nbsp;&nbsp;&nbsp;235</code>** [bubble-table](https://github.com/Evertras/bubble-table) - An interactive table component for bubbletea.
...
- **<code>&nbsp;33090</code>** [cobra](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.
...
- **<code>&nbsp;&nbsp;3932</code>** [survey](https://github.com/go-survey/survey) - Build interactive and accessible prompts with full support for windows and posix terminals.
...
- **<code>&nbsp;&nbsp;2430</code>** [go-flags](https://github.com/jessevdk/go-flags) - go command line option parser.
...
- **<code>&nbsp;&nbsp;&nbsp;989</code>** [liner](https://github.com/peterh/liner) - Go readline-like library for command-line interfaces.
...
- **<code>&nbsp;&nbsp;&nbsp;693</code>** [cli](https://github.com/mkideal/cli) - Feature-rich and easy to use command-line package based on golang struct tags.
...
- **<code>&nbsp;&nbsp;&nbsp;280</code>** [carapace-bin](https://github.com/rsteube/carapace-bin) - Multi-shell multi-command argument completer.
...
- **<code>&nbsp;23812</code>** [viper](https://github.com/spf13/viper) - Go configuration with fangs.
- **<code>&nbsp;&nbsp;6548</code>** [godotenv](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- **<code>&nbsp;&nbsp;3765</code>** [env](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).
- **<code>&nbsp;&nbsp;3298</code>** [ini](https://github.com/go-ini/ini) - Go package to read and write INI files.
- **<code>&nbsp;&nbsp;1967</code>** [koanf](https://github.com/knadh/koanf) - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- **<code>&nbsp;27191</code>** [drone](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.
- **<code>&nbsp;&nbsp;4267</code>** [CDS](https://github.com/ovh/cds) - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
- **<code>&nbsp;&nbsp;2932</code>** [woodpecker](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
...
- **<code>&nbsp;&nbsp;2118</code>** [roaring](https://github.com/RoaringBitmap/roaring) - Go package implementing compressed bitsets.
...
- **<code>&nbsp;&nbsp;2019</code>** [bloom](https://github.com/bits-and-blooms/bloom) - Go package implementing Bloom filters.
...
- **<code>&nbsp;14168</code>** [gods](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- **<code>&nbsp;&nbsp;&nbsp;909</code>** [gostl](https://github.com/liyue201/gostl) - Data structure and algorithm library for go, designed to provide functions similar to C++ STL.
...
- **<code>&nbsp;&nbsp;3438</code>** [golang-set](https://github.com/deckarep/golang-set) - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- **<code>&nbsp;&nbsp;9216</code>** [bleve](https://github.com/blevesearch/bleve) - Modern text indexing library for go.
...
- **<code>&nbsp;12279</code>** [groupcache](https://github.com/golang/groupcache) - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
- **<code>&nbsp;&nbsp;6728</code>** [BigCache](https://github.com/allegro/bigcache) - Efficient key/value cache for gigabytes of data.
...
- **<code>&nbsp;&nbsp;1919</code>** [gocache](https://github.com/eko/gocache) - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
- **<code>&nbsp;&nbsp;1831</code>** [fastcache](https://github.com/VictoriaMetrics/fastcache) - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
...
- **<code>&nbsp;49611</code>** [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
- **<code>&nbsp;34710</code>** [tidb](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.
- **<code>&nbsp;27667</code>** [cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
- **<code>&nbsp;26024</code>** [influxdb](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.
- **<code>&nbsp;22432</code>** [Milvus](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
- **<code>&nbsp;19546</code>** [dgraph](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- **<code>&nbsp;15459</code>** [dolt](https://github.com/dolthub/dolt) - Dolt – It's Git for Data.
- **<code>&nbsp;13960</code>** [rqlite](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
- **<code>&nbsp;13688</code>** [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
- **<code>&nbsp;12657</code>** [badger](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
- **<code>&nbsp;&nbsp;9145</code>** [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
- **<code>&nbsp;&nbsp;8331</code>** [immudb](https://github.com/codenotary/immudb) - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- **<code>&nbsp;&nbsp;6828</code>** [bbolt](https://github.com/etcd-io/bbolt) - An embedded key/value database for Go.
- **<code>&nbsp;&nbsp;5819</code>** [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go.
...
- **<code>&nbsp;&nbsp;3945</code>** [rosedb](https://github.com/roseduan/rosedb) - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- **<code>&nbsp;&nbsp;2984</code>** [nutsdb](https://github.com/xujiajun/nutsdb) - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
...
- **<code>&nbsp;&nbsp;&nbsp;906</code>** [objectbox-go](https://github.com/objectbox/objectbox-go) - High-performance embedded Object Database (NoSQL) with Go API.
...
- **<code>&nbsp;12097</code>** [migrate](https://github.com/golang-migrate/migrate) - Database migrations. CLI and Golang library.
- **<code>&nbsp;&nbsp;6704</code>** [bytebase](https://github.com/bytebase/bytebase) - Safe database schema change and version control for DevOps teams.
- **<code>&nbsp;&nbsp;4289</code>** [goose](https://github.com/pressly/goose) - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
- **<code>&nbsp;&nbsp;3651</code>** [dbmate](https://github.com/amacneil/dbmate) - A lightweight, framework-agnostic database migration tool.
- **<code>&nbsp;&nbsp;3543</code>** [atlas](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
- **<code>&nbsp;&nbsp;2923</code>** [sql-migrate](https://github.com/rubenv/sql-migrate) - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
- **<code>&nbsp;&nbsp;&nbsp;909</code>** [goavro](https://github.com/linkedin/goavro) - A Go package that encodes and decodes Avro data.
...
- **<code>&nbsp;16661</code>** [vitess](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- **<code>&nbsp;&nbsp;5125</code>** [orchestrator](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer.
- **<code>&nbsp;&nbsp;4185</code>** [go-mysql](https://github.com/siddontang/go-mysql) - Go toolset to handle MySQL protocol and replication.
...
- **<code>&nbsp;&nbsp;3878</code>** [pREST](https://github.com/prest/prest) - Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
- **<code>&nbsp;&nbsp;8887</code>** [sqlc](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
- **<code>&nbsp;&nbsp;5982</code>** [Squirrel](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries.
- **<code>&nbsp;&nbsp;3424</code>** [xo](https://github.com/knq/xo) - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
- **<code>&nbsp;&nbsp;1465</code>** [jet](https://github.com/go-jet/jet) - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- **<code>&nbsp;13614</code>** [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.
- **<code>&nbsp;&nbsp;8248</code>** [pq](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.
- **<code>&nbsp;&nbsp;7617</code>** [pgx](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
- **<code>&nbsp;&nbsp;6813</code>** [go-sqlite3](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.
...
- **<code>&nbsp;17860</code>** [redis](https://github.com/redis/go-redis) - Redis client for Golang.
- **<code>&nbsp;&nbsp;9589</code>** [redigo](https://github.com/gomodule/redigo) - Redigo is a Go client for the Redis database.
- **<code>&nbsp;&nbsp;7585</code>** [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - Official MongoDB driver for the Go language.
...
- **<code>&nbsp;&nbsp;1825</code>** [rueidis](http://github.com/rueian/rueidis) - Fast Redis RESP3 client with auto pipelining and server-assisted client side caching.
...
- **<code>&nbsp;&nbsp;1083</code>** [elasticsql](https://github.com/cch123/elasticsql) - Convert sql to elasticsearch dsl in Go.
...
- **<code>107003</code>** [pjrpc](https://gitlab.com/pjrpc/pjrpc) - Golang JSON-RPC Server-Client with Protobuf spec.
- **<code>&nbsp;25334</code>** [go-kit](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- **<code>&nbsp;25282</code>** [go-zero](https://github.com/tal-tech/go-zero) - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
...
- **<code>&nbsp;20763</code>** [go-micro](https://github.com/micro/go-micro) - A distributed systems development framework.
- **<code>&nbsp;18656</code>** [grpc-go](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.
- **<code>&nbsp;13429</code>** [NATS](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.
- **<code>&nbsp;11853</code>** [micro](https://github.com/micro/micro) - A distributed systems runtime for the cloud and beyond.
...
- **<code>&nbsp;&nbsp;6171</code>** [Kitex](https://github.com/cloudwego/kitex) - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- **<code>&nbsp;&nbsp;5692</code>** [lura](https://github.com/luraproject/lura) - Ultra performant API Gateway framework with middlewares.
- **<code>&nbsp;&nbsp;4901</code>** [torrent](https://github.com/anacrolix/torrent) - BitTorrent client package.
...
- **<code>&nbsp;&nbsp;3233</code>** [gleam](https://github.com/chrislusf/gleam) - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
...
- **<code>&nbsp;12457</code>** [MailHog](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.
- **<code>&nbsp;&nbsp;2888</code>** [Mailpit](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
- **<code>&nbsp;&nbsp;2658</code>** [hermes](https://github.com/matcornic/hermes) - Golang package that generates clean, responsive HTML e-mails.
- **<code>&nbsp;&nbsp;2402</code>** [email](https://github.com/jordan-wright/email) - A robust and flexible email library for Go.
- **<code>&nbsp;&nbsp;1831</code>** [go-imap](https://github.com/emersion/go-imap) - IMAP library for clients and servers.
...
- **<code>&nbsp;&nbsp;&nbsp;645</code>** [chasquid](https://blitiri.com.ar/p/chasquid) - SMTP server written in Go.
...
- **<code>&nbsp;&nbsp;4240</code>** [expr](https://github.com/antonmedv/expr) - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
- **<code>&nbsp;&nbsp;4185</code>** [goja](https://github.com/dop251/goja) - ECMAScript 5.1(+) implementation in Go.
...
- **<code>&nbsp;&nbsp;1766</code>** [cel-go](https://github.com/google/cel-go) - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
- **<code>&nbsp;&nbsp;5298</code>** [afero](https://github.com/spf13/afero) - FileSystem Abstraction System for Go.
- **<code>&nbsp;&nbsp;5234</code>** [pdfcpu](https://github.com/pdfcpu/pdfcpu) - PDF processor.
- **<code>&nbsp;&nbsp;2719</code>** [gdu](https://github.com/dundee/gdu) - Disk usage analyzer with console interface.
...
- **<code>&nbsp;&nbsp;&nbsp;588</code>** [copy](https://github.com/otiai10/copy) - Copy directory recursively.
- **<code>&nbsp;&nbsp;&nbsp;324</code>** [gofs](https://github.com/no-src/gofs) - A cross-platform real-time file synchronization tool out of the box.
...
- **<code>&nbsp;&nbsp;5300</code>** [decimal](https://github.com/shopspring/decimal) - Arbitrary-precision fixed-point decimal numbers.
- **<code>&nbsp;&nbsp;4639</code>** [ticker](https://github.com/achannarasappa/ticker) - Terminal stock watcher and stock position tracker.
- **<code>&nbsp;&nbsp;1352</code>** [go-money](https://github.com/rhymond/go-money) - Implementation of Fowler's Money pattern.
- **<code>&nbsp;&nbsp;&nbsp;939</code>** [bbgo](https://github.com/c9s/bbgo) - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- **<code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1</code>** [decimal](https://github.com/govalues/decimal) - Immutable decimal numbers with panic-free arithmetic.
...
- **<code>&nbsp;&nbsp;1434</code>** [nosurf](https://github.com/justinas/nosurf) - CSRF protection middleware for Go.
...
- **<code>&nbsp;&nbsp;&nbsp;250</code>** [fp-go](https://github.com/repeale/fp-go) - Collection of Functional Programming helpers powered by Golang 1.18+ generics.
- **<code>&nbsp;&nbsp;&nbsp;192</code>** [go-functional](https://github.com/BooleanCat/go-functional) - Functional programming in Go using generics
...
- **<code>&nbsp;&nbsp;8623</code>** [Ebitengine](https://github.com/hajimehoshi/ebiten) - dead simple 2D game engine in Go.
- **<code>&nbsp;&nbsp;4953</code>** [Leaf](https://github.com/name5566/leaf) - Lightweight game server framework.
- **<code>&nbsp;&nbsp;4285</code>** [Pixel](https://github.com/faiface/pixel) - Hand-crafted 2D game library in Go.
- **<code>&nbsp;&nbsp;2450</code>** [nano](https://github.com/lonng/nano) - Lightweight, facility, high performance golang based game server framework.
- **<code>&nbsp;&nbsp;2412</code>** [g3n](https://github.com/g3n/engine) - Go 3D Game Engine.
- **<code>&nbsp;&nbsp;2388</code>** [goworld](https://github.com/xiaonanln/goworld) - Scalable game server engine, featuring space-entity framework and hot-swapping.
...
- **<code>&nbsp;&nbsp;3347</code>** [go-linq](https://github.com/ahmetalpbalkan/go-linq) - .NET LINQ-like query methods for Go.
- **<code>&nbsp;&nbsp;2984</code>** [jennifer](https://github.com/dave/jennifer) - Generate arbitrary Go code without templates.
...
- **<code>&nbsp;&nbsp;8646</code>** [Tile38](https://github.com/tidwall/tile38) - Geolocation DB with spatial index and realtime geofencing.
- **<code>&nbsp;&nbsp;1561</code>** [S2 geometry](https://github.com/golang/geo) - S2 geometry library in Go.
- **<code>&nbsp;&nbsp;&nbsp;520</code>** [mbtileserver](https://github.com/consbio/mbtileserver) - A simple Go-based server for map tiles stored in mbtiles format.
...
- **<code>&nbsp;10888</code>** [ants](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
- **<code>&nbsp;&nbsp;7189</code>** [conc](https://github.com/sourcegraph/conc) - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- **<code>&nbsp;&nbsp;&nbsp;962</code>** [pond](https://github.com/alitto/pond) - Minimalistic and High-performance goroutine worker pool written in Go.
...
- **<code>&nbsp;21159</code>** [fyne](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
- **<code>&nbsp;11421</code>** [webview](https://github.com/zserge/webview) - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
- **<code>&nbsp;&nbsp;9934</code>** [qt](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
- **<code>&nbsp;&nbsp;8293</code>** [ui](https://github.com/andlabs/ui) - Platform-native GUI library for Go. Cross platform.
- **<code>&nbsp;&nbsp;7211</code>** [app](https://github.com/murlokswarm/app) - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- **<code>&nbsp;&nbsp;6520</code>** [walk](https://github.com/lxn/walk) - Windows application library kit for Go.
...
- **<code>&nbsp;&nbsp;8605</code>** [robotgo](https://github.com/go-vgo/robotgo) - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- **<code>&nbsp;&nbsp;&nbsp;532</code>** [zenity](https://github.com/ncruces/zenity) - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
- **<code>&nbsp;&nbsp;5683</code>** [gocv](https://github.com/hybridgroup/gocv) - Go package for computer vision using OpenCV 3.3+.
...
- **<code>&nbsp;&nbsp;4011</code>** [gg](https://github.com/fogleman/gg) - 2D rendering in pure Go.
- **<code>&nbsp;&nbsp;3821</code>** [bild](https://github.com/anthonynsimon/bild) - Collection of image processing algorithms in pure Go.
- **<code>&nbsp;&nbsp;3197</code>** [ln](https://github.com/fogleman/ln) - 3D line art rendering in Go.
...
- **<code>&nbsp;&nbsp;1879</code>** [picfit](https://github.com/thoas/picfit) - An image resizing server written in Go.
...
- **<code>&nbsp;&nbsp;1607</code>** [imagick](https://github.com/gographics/imagick) - Go binding to ImageMagick's MagickWand C API.
...
- **<code>&nbsp;&nbsp;8390</code>** [gobot](https://github.com/hybridgroup/gobot/) - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
- **<code>&nbsp;&nbsp;2132</code>** [mainflux](https://github.com/Mainflux/mainflux) - Industrial IoT Messaging and Device Management Server.
...
- **<code>&nbsp;&nbsp;3843</code>** [gocron](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
...
- **<code>&nbsp;&nbsp;&nbsp;863</code>** [Dagu](https://github.com/dagu-go/dagu) - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- **<code>&nbsp;23148</code>** [logrus](https://github.com/Sirupsen/logrus) - Structured logger for Go.
- **<code>&nbsp;19540</code>** [zap](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
- **<code>&nbsp;&nbsp;8754</code>** [zerolog](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
- **<code>&nbsp;&nbsp;2585</code>** [tail](https://github.com/hpcloud/tail) - Go package striving to emulate the features of the BSD tail program.
...
- **<code>&nbsp;&nbsp;&nbsp;315</code>** [sqldb-logger](https://github.com/simukti/sqldb-logger) - A logger for Go SQL database driver without modify existing \*sql.DB stdlib usage.
...
- **<code>&nbsp;&nbsp;&nbsp;273</code>** [tint](https://github.com/lmittmann/tint) - A slog.Handler that writes tinted logs.
...
- **<code>&nbsp;&nbsp;&nbsp;&nbsp;96</code>** [slog-multi](https://github.com/samber/slog-multi) - Chain of slog.Handler (pipeline, fanout...).
...
- **<code>&nbsp;&nbsp;5092</code>** [gorgonia](https://github.com/gorgonia/gorgonia) - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- **<code>&nbsp;&nbsp;&nbsp;525</code>** [onnx-go](https://github.com/owulveryck/onnx-go) - Go Interface to Open Neural Network Exchange (ONNX).
...
- **<code>&nbsp;10279</code>** [sarama](https://github.com/Shopify/sarama) - Go library for Apache Kafka.
- **<code>&nbsp;&nbsp;7308</code>** [Centrifugo](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
...
- **<code>&nbsp;&nbsp;6680</code>** [Asynq](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
- **<code>&nbsp;&nbsp;6529</code>** [Benthos](https://github.com/Jeffail/benthos) - A message streaming bridge between a range of protocols.
- **<code>&nbsp;&nbsp;5998</code>** [Watermill](https://github.com/ThreeDotsLabs/watermill) - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
- **<code>&nbsp;&nbsp;5285</code>** [go-socket.io](https://github.com/googollee/go-socket.io) - socket.io library for golang, a realtime application framework.
- **<code>&nbsp;&nbsp;4719</code>** [NATS Go Client](https://github.com/nats-io/nats) - Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library.
...
- **<code>&nbsp;&nbsp;3256</code>** [melody](https://github.com/olahol/melody) - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
...
- **<code>&nbsp;11151</code>** [google/wire](https://github.com/google/wire) - Automated Initialization in Go.
- **<code>&nbsp;&nbsp;4302</code>** [fx](https://github.com/uber-go/fx) - A dependency injection based application framework for Go (built on top of dig).
- **<code>&nbsp;&nbsp;3346</code>** [dig](https://github.com/uber-go/dig) - A reflection based dependency injection toolkit for Go.
- **<code>&nbsp;&nbsp;1215</code>** [do](https://github.com/samber/do) - A dependency injection framework based on Generics.
...
- **<code>&nbsp;41383</code>** [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful.
...
- **<code>&nbsp;&nbsp;&nbsp;898</code>** [pagoda](https://github.com/mikestefanello/pagoda) - Rapid, easy full-stack web development starter kit built in Go.
...
- **<code>&nbsp;&nbsp;&nbsp;375</code>** [go-starter](https://github.com/allaboutapps/go-starter) - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
...
- **<code>107003</code>** [go-formatter](https://gitlab.com/tymonx/go-formatter) - Implements **replacement fields** surrounded by curly braces `{}` format strings.
...
- **<code>&nbsp;&nbsp;9379</code>** [gopsutil](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
- **<code>&nbsp;&nbsp;4046</code>** [archiver](https://github.com/mholt/archiver) - Library and command for making and extracting .zip and .tar.gz archives.
- **<code>&nbsp;&nbsp;3990</code>** [gatus](https://github.com/TwinProduction/gatus) - Automated service health dashboard.
- **<code>&nbsp;&nbsp;3251</code>** [gofakeit](https://github.com/brianvoe/gofakeit) - Random data generator written in go.
- **<code>&nbsp;&nbsp;1853</code>** [go-resiliency](https://github.com/eapache/go-resiliency) - Resiliency patterns for golang.
...
- **<code>&nbsp;&nbsp;1560</code>** [spaGO](https://github.com/nlpodyssey/spago) - Self-contained Machine Learning and Natural Language Processing library in Go.
...
- **<code>&nbsp;&nbsp;&nbsp;997</code>** [slug](https://github.com/gosimple/slug) - URL-friendly slugify with multiple languages support.
...
- **<code>&nbsp;&nbsp;2494</code>** [go-i18n](https://github.com/nicksnyder/go-i18n/) - Package and an accompanying tool to work with localized text.
...
- **<code>&nbsp;20028</code>** [fasthttp](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- **<code>&nbsp;&nbsp;7964</code>** [gnet](https://github.com/panjf2000/gnet) - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
- **<code>&nbsp;&nbsp;7169</code>** [dns](https://github.com/miekg/dns) - Go library for working with DNS.
...
- **<code>&nbsp;&nbsp;2998</code>** [fortio](https://github.com/fortio/fortio) - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- **<code>&nbsp;&nbsp;&nbsp;902</code>** [gmqtt](https://github.com/DrmagicE/gmqtt) - Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.
...
- **<code>&nbsp;&nbsp;&nbsp;415</code>** [gws](https://github.com/lxzan/gws) - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
- **<code>&nbsp;33375</code>** [GORM](https://github.com/go-gorm/gorm) - The fantastic ORM library for Golang, aims to be developer friendly.
- **<code>&nbsp;13971</code>** [ent](https://github.com/facebook/ent) - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
- **<code>&nbsp;&nbsp;5970</code>** [SQLBoiler](https://github.com/volatiletech/sqlboiler) - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
- **<code>&nbsp;&nbsp;3676</code>** [gorp](https://github.com/go-gorp/gorp) - Go Relational Persistence, ORM-ish library for Go.
- **<code>&nbsp;&nbsp;3370</code>** [upper.io/db](https://github.com/upper/db) - Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers.
- **<code>&nbsp;&nbsp;2932</code>** [XORM](https://gitea.com/xorm/xorm) - Simple and powerful ORM for Go. (Support: MySQL, MyMysql, PostgreSQL, Tidb, SQLite3, MsSql and Oracle).
...
- **<code>113859</code>** [go modules](https://golang.org/cmd/go/#hdr-Modules__module_versions__and_more) - Modules are the unit of source code interchange and versioning. The go command has direct support for working with modules, including recording and resolving dependencies on other modules.
...
- **<code>&nbsp;18157</code>** [jaeger](https://github.com/jaegertracing/jaeger) - A distributed tracing system.
- **<code>&nbsp;&nbsp;4788</code>** [pixie](https://github.com/pixie-labs/pixie) - No instrumentation tracing for Golang applications via eBPF.
- **<code>&nbsp;&nbsp;2926</code>** [statsviz](https://github.com/arl/statsviz) - Live visualization of your Go application runtime statistics.
- **<code>&nbsp;&nbsp;1893</code>** [profile](https://github.com/pkg/profile) - Simple profiling support package for Go.
...
- **<code>&nbsp;&nbsp;9367</code>** [graphql-go](https://github.com/graphql-go/graphql) - Implementation of GraphQL for Go.
- **<code>&nbsp;&nbsp;9128</code>** [gqlgen](https://github.com/99designs/gqlgen) - go generate based graphql server library.
- **<code>&nbsp;&nbsp;4517</code>** [graphql](https://github.com/neelance/graphql-go) - GraphQL server with a focus on ease of use.
...
- **<code>&nbsp;&nbsp;3640</code>** [statik](https://github.com/rakyll/statik) - Embeds static files into a Go executable.
...
- **<code>&nbsp;&nbsp;6775</code>** [gonum](https://github.com/gonum/gonum) - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
- **<code>&nbsp;&nbsp;2800</code>** [stats](https://github.com/montanaflynn/stats) - Statistics package with common functions missing from the Golang standard library.
...
- **<code>&nbsp;&nbsp;&nbsp;712</code>** [orb](https://github.com/paulmach/orb) - 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support.
...
- **<code>113859</code>** [autocert](https://godoc.org/golang.org/x/crypto/acme/autocert) - Auto provision Let's Encrypt certificates and start a TLS server.
- **<code>&nbsp;13950</code>** [age](https://github.com/FiloSottile/age) - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
- **<code>&nbsp;&nbsp;6404</code>** [lego](https://github.com/go-acme/lego) - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
- **<code>&nbsp;&nbsp;4594</code>** [CertMagic](https://github.com/caddyserver/certmagic) - Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.
...
- **<code>&nbsp;&nbsp;1305</code>** [Coraza](https://github.com/corazawaf/coraza) - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- **<code>&nbsp;&nbsp;&nbsp;743</code>** [dongle](https://github.com/golang-module/dongle) - A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption.
...
- **<code>&nbsp;12533</code>** [jsoniter](https://github.com/json-iterator/go) - High-performance 100% compatible drop-in replacement of "encoding/json".
- **<code>&nbsp;&nbsp;9212</code>** [goprotobuf](https://github.com/golang/protobuf) - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
- **<code>&nbsp;&nbsp;7065</code>** [mapstructure](https://github.com/mitchellh/mapstructure) - Go library for decoding generic map values into native Go structures.
...
- **<code>&nbsp;49256</code>** [Caddy](https://github.com/caddyserver/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- **<code>&nbsp;44306</code>** [etcd](https://github.com/coreos/etcd) - Highly-available key value store for shared configuration and service discovery.
- **<code>&nbsp;40517</code>** [minio](https://github.com/minio/minio) - Minio is a distributed object storage server.
- **<code>&nbsp;23725</code>** [nsq](https://nsq.io/) - A realtime distributed messaging platform.
- **<code>&nbsp;&nbsp;7338</code>** [RoadRunner](https://github.com/spiral/roadrunner) - High-performance PHP application server, load-balancer and process manager.
- **<code>&nbsp;&nbsp;6670</code>** [SFTPGo](https://github.com/drakkan/sftpgo) - Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.
- **<code>&nbsp;&nbsp;5529</code>** [Easegress](https://github.com/megaease/easegress) - A cloud native high availability/performance traffic orchestration system with observability and extensibility.
- **<code>&nbsp;&nbsp;3346</code>** [devd](https://github.com/cortesi/devd) - Local webserver for developers.
- **<code>&nbsp;&nbsp;2770</code>** [flipt](https://github.com/markphelps/flipt) - A self contained feature flag solution written in Go and Vue.js
...
- **<code>&nbsp;&nbsp;2216</code>** [Flagr](https://github.com/checkr/flagr) - Flagr is an open-source feature flagging and A/B testing service.
...
- **<code>&nbsp;&nbsp;1526</code>** [go-streams](https://github.com/reugn/go-streams) - Go stream processing library.
...
- **<code>&nbsp;&nbsp;3705</code>** [sprig](https://github.com/Masterminds/sprig) - Useful template functions for Go templates.
- **<code>&nbsp;&nbsp;2839</code>** [quicktemplate](https://github.com/valyala/quicktemplate) - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
- **<code>&nbsp;&nbsp;2624</code>** [pongo2](https://github.com/flosch/pongo2) - Django-like template-engine for Go.
- **<code>&nbsp;&nbsp;1070</code>** [jet](https://github.com/CloudyKit/jet) - Jet template engine.
...
- **<code>&nbsp;&nbsp;&nbsp;363</code>** [goview](https://github.com/foolin/goview) - Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application.
- **<code>&nbsp;&nbsp;&nbsp;224</code>** [liquid](https://github.com/osteele/liquid) - Go implementation of Shopify Liquid templates.
...
- Testing Frameworks
  ...
  - **<code>113859</code>** [testmd](https://godoc.org/github.com/tvastar/test/cmd/testmd) - Convert markdown snippets into testable go code.
  - **<code>&nbsp;20437</code>** [Testify](https://github.com/stretchr/testify) - Sacred extension to the standard go testing package.
  ...
  - **<code>&nbsp;&nbsp;2387</code>** [testcontainers-go](https://github.com/testcontainers/testcontainers-go) - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
  - **<code>&nbsp;&nbsp;2290</code>** [httpexpect](https://github.com/gavv/httpexpect) - Concise, declarative, and easy to use end-to-end HTTP and REST API testing.
  ...
  - **<code>&nbsp;&nbsp;&nbsp;974</code>** [testfixtures](https://github.com/go-testfixtures/testfixtures) - A helper for Rails' like test fixtures to test database applications.
...
- Mock
  ...
  - **<code>107003</code>** [genmock](https://gitlab.com/so_literate/genmock) - Go mocking system with code generator for building calls of the interface methods.
  - **<code>&nbsp;&nbsp;9070</code>** [gomock](https://github.com/golang/mock) - Mocking framework for the Go programming language.
  - **<code>&nbsp;&nbsp;5441</code>** [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - Mock SQL driver for testing database interactions.
  - **<code>&nbsp;&nbsp;4924</code>** [mockery](https://github.com/vektra/mockery) - Tool to generate Go interfaces.
...
- Selenium and browser control tools.
  ...
  - **<code>&nbsp;&nbsp;9443</code>** [chromedp](https://github.com/knq/chromedp) - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
  - **<code>&nbsp;&nbsp;4077</code>** [rod](https://github.com/go-rod/rod) - A Devtools driver to make web automation and scraping easy.
  - **<code>&nbsp;&nbsp;2401</code>** [selenoid](https://github.com/aerokube/selenoid) - alternative Selenium hub server that launches browsers within containers.
  - **<code>&nbsp;&nbsp;1407</code>** [playwright-go](https://github.com/mxschmitt/playwright-go) - browser automation library to control Chromium, Firefox and WebKit with a single API.
  - **<code>&nbsp;&nbsp;&nbsp;683</code>** [cdp](https://github.com/mafredri/cdp) - Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it.
...
- **<code>&nbsp;&nbsp;3720</code>** [go-humanize](https://github.com/dustin/go-humanize) - Formatters for time, numbers, and memory size to human readable format.
...
- **<code>113859</code>** [github_flavored_markdown](https://godoc.org/github.com/shurcooL/github_flavored_markdown) - GitHub Flavored Markdown renderer (using blackfriday) with fenced code block highlighting, clickable header anchor links.
- **<code>&nbsp;&nbsp;5212</code>** [blackfriday](https://github.com/russross/blackfriday) - Markdown processor in Go.
...
- **<code>&nbsp;&nbsp;6116</code>** [sh](https://github.com/mvdan/sh) - Shell parser and formatter.
...
- **<code>&nbsp;&nbsp;2777</code>** [bluemonday](https://github.com/microcosm-cc/bluemonday) - HTML Sanitizer.
- **<code>&nbsp;&nbsp;&nbsp;&nbsp;57</code>** [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) - A sanitization-based swear filter for Go.

### Scrapers

- **<code>&nbsp;20564</code>** [colly](https://github.com/asciimoo/colly) - Fast and Elegant Scraping Framework for Gophers.
- **<code>&nbsp;12873</code>** [GoQuery](https://github.com/PuerkitoBio/goquery) - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- **<code>&nbsp;&nbsp;9619</code>** [github](https://github.com/google/go-github) - Go library for accessing the GitHub REST API v3.
- **<code>&nbsp;&nbsp;8391</code>** [aws-sdk-go](https://github.com/aws/aws-sdk-go) - The official AWS SDK for the Go programming language.
- **<code>&nbsp;&nbsp;6256</code>** [go-openai](https://github.com/sashabaranov/go-openai) - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
- **<code>&nbsp;&nbsp;4392</code>** [slack](https://github.com/slack-go/slack) - Slack API in Go.
- **<code>&nbsp;&nbsp;4199</code>** [discordgo](https://github.com/bwmarrin/discordgo) - Go bindings for the Discord Chat API.
- **<code>&nbsp;&nbsp;3544</code>** [google](https://github.com/google/google-api-go-client) - Auto-generated Google APIs for Go.
- **<code>&nbsp;&nbsp;3350</code>** [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - Google Cloud APIs Go Client Library.
- **<code>&nbsp;&nbsp;2033</code>** [minio-go](https://github.com/minio/minio-go) - Minio Go Library for Amazon S3 compatible cloud storage.
- **<code>&nbsp;&nbsp;1840</code>** [stripe](https://github.com/stripe/stripe-go) - Go client for the Stripe API.
...
- **<code>&nbsp;&nbsp;&nbsp;655</code>** [twitter-scraper](https://github.com/n0madic/twitter-scraper) - Scrape the Twitter Frontend API without authentication and limits.
...
- **<code>&nbsp;53990</code>** [fzf](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.
- **<code>&nbsp;37913</code>** [dive](https://github.com/wagoodman/dive) - A tool for exploring each layer in a Docker image.
...
- **<code>&nbsp;14555</code>** [ctop](https://github.com/bcicen/ctop) - [Top-like](https://ctop.sh) interface (e.g. htop) for container metrics.
- **<code>&nbsp;14149</code>** [sqlx](https://github.com/jmoiron/sqlx) - provides a set of extensions on top of the excellent built-in database/sql package.
- **<code>&nbsp;12952</code>** [lo](https://github.com/samber/lo) - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
- **<code>&nbsp;12003</code>** [goreleaser](https://github.com/goreleaser/goreleaser) - Deliver Go binaries as fast and easily as possible.
- **<code>&nbsp;11351</code>** [air](https://github.com/cosmtrek/air) - Air - Live reload for Go apps.
- **<code>&nbsp;10359</code>** [wuzz](https://github.com/asciimoo/wuzz) - Interactive cli tool for HTTP inspection.
- **<code>&nbsp;&nbsp;8199</code>** [usql](https://github.com/knq/usql) - usql is a universal command-line interface for SQL databases.
- **<code>&nbsp;&nbsp;7412</code>** [peco](https://github.com/peco/peco) - Simplistic interactive filtering tool.
- **<code>&nbsp;&nbsp;4354</code>** [go-funk](https://github.com/thoas/go-funk) - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
- **<code>&nbsp;&nbsp;4139</code>** [godropbox](https://github.com/dropbox/godropbox) - Common libraries for writing Go services/applications from Dropbox.
...
- **<code>&nbsp;&nbsp;3406</code>** [minify](https://github.com/tdewolff/minify) - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
...
- **<code>&nbsp;&nbsp;2874</code>** [lancet](https://github.com/duke-git/lancet) - A comprehensive, efficient, and reusable util function library of go.
...
- **<code>&nbsp;&nbsp;2173</code>** [create-go-app](https://github.com/create-go-app/cli) - A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command.
...
- **<code>&nbsp;&nbsp;1859</code>** [retry-go](https://github.com/avast/retry-go) - Simple library for retry mechanism.
- **<code>&nbsp;&nbsp;1665</code>** [jump](https://github.com/gsamokovarov/jump) - Jump helps you navigate faster by learning your habits.
...
- **<code>&nbsp;&nbsp;4538</code>** [uuid](https://github.com/google/uuid) - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
- **<code>&nbsp;&nbsp;3632</code>** [ulid](https://github.com/oklog/ulid) - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- **<code>&nbsp;13825</code>** [validator](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
- **<code>&nbsp;&nbsp;5760</code>** [govalidator](https://github.com/asaskevich/govalidator) - Validators and sanitizers for strings, numerics, slices and structs.
- **<code>&nbsp;&nbsp;3303</code>** [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- **<code>107003</code>** [cli](https://gitlab.com/gitlab-org/cli) - An open-source GitLab command line tool bringing GitLab's cool features to your command line.
- **<code>&nbsp;&nbsp;4880</code>** [go-git](https://github.com/go-git/go-git) - highly extensible Git implementation in pure Go.
...
- **<code>&nbsp;&nbsp;&nbsp;490</code>** [go-astisub](https://github.com/asticode/go-astisub) - Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.).
...
- **<code>&nbsp;71024</code>** [Gin](https://github.com/gin-gonic/gin) - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
- **<code>&nbsp;30111</code>** [Beego](https://github.com/beego/beego) - beego is an open-source, high-performance web framework for the Go programming language.
- **<code>&nbsp;27980</code>** [Fiber](https://github.com/gofiber/fiber) - An Express.js inspired web framework build on Fasthttp.
- **<code>&nbsp;26410</code>** [Echo](https://github.com/labstack/echo) - High performance, minimalist Go web framework.
- **<code>&nbsp;12961</code>** [Revel](https://github.com/revel/revel) - High-productivity web framework for the Go language.
- **<code>&nbsp;&nbsp;9904</code>** [GoFrame](https://github.com/gogf/gf) - GoFrame is a modular, full-featured and production-ready application development framework of golang.
...
- **<code>&nbsp;&nbsp;2407</code>** [CORS](https://github.com/rs/cors) - Easily add CORS capabilities to your API.
...
- **<code>&nbsp;19024</code>** [mux](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.
- **<code>&nbsp;15652</code>** [httprouter](https://github.com/julienschmidt/httprouter) - High performance router. Use this and the standard http handlers to form a very high performance web framework.
- **<code>&nbsp;15070</code>** [chi](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.
...
- **<code>&nbsp;13346</code>** [tinygo](https://github.com/tinygo-org/tinygo) - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- **<code>&nbsp;&nbsp;1482</code>** [Spire](https://github.com/spiffe/spire) - SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms.
...
- **<code>113859</code>** [goimports](https://godoc.org/golang.org/x/tools/cmd/goimports) - Tool to fix (add, remove) your Go imports automatically.
...
- **<code>&nbsp;&nbsp;&nbsp;670</code>** [golines](https://github.com/segmentio/golines) - Formatter that automatically shortens long lines in Go code.
...
- **<code>&nbsp;&nbsp;&nbsp;318</code>** [dupl](https://github.com/mibk/dupl) - Tool for code clone detection.
...
- **<code>&nbsp;15555</code>** [vim-go](https://github.com/fatih/vim-go) - Go development plugin for Vim.
- **<code>&nbsp;&nbsp;5007</code>** [gocode](https://github.com/nsf/gocode) - Autocompletion daemon for the Go programming language.
- **<code>&nbsp;&nbsp;3509</code>** [vscode-go](https://github.com/golang/vscode-go) - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- **<code>&nbsp;&nbsp;5169</code>** [OctoLinker](https://github.com/OctoLinker/browser-extension) - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.
...
- **<code>101114</code>** [kubernetes](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
- **<code>&nbsp;66558</code>** [Moby](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems.
- **<code>&nbsp;44348</code>** [traefik](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.
- **<code>&nbsp;42798</code>** [Gogs](https://gogs.io/) - A Self Hosted Git Service in the Go Programming Language.
- **<code>&nbsp;38058</code>** [gitea-github-migrator](https://git.jonasfranz.software/JonasFranzDEV/gitea-github-migrator) - Migrate all your GitHub repositories, issues, milestones and labels to your Gitea instance.
- **<code>&nbsp;38058</code>** [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.
- **<code>&nbsp;21737</code>** [Vegeta](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!
- **<code>&nbsp;16120</code>** [Hey](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.
- **<code>&nbsp;14575</code>** [Packer](https://github.com/mitchellh/packer) - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
- **<code>&nbsp;&nbsp;9450</code>** [kubeshark](https://github.com/kubeshark/kubeshark) - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- **<code>&nbsp;&nbsp;9224</code>** [webhook](https://github.com/adnanh/webhook) - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
- **<code>&nbsp;&nbsp;8740</code>** [GVM](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.
- **<code>&nbsp;&nbsp;7694</code>** [Ddosify](https://github.com/ddosify/ddosify) - High-performance load testing tool, written in Golang.
- **<code>&nbsp;&nbsp;6280</code>** [ko](https://github.com/google/ko) - Command line tool for building and deploying Go applications on Kubernetes
- **<code>&nbsp;&nbsp;5539</code>** [KubeVela](https://github.com/kubevela/kubevela) - Cloud native application delivery.
...
- **<code>&nbsp;&nbsp;4507</code>** [bombardier](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool.
- **<code>&nbsp;&nbsp;4495</code>** [script](https://github.com/bitfield/script) - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- **<code>&nbsp;&nbsp;1499</code>** [Fleet device management](https://github.com/fleetdm/fleet) - Lightweight, programmable telemetry for servers and workstations.
...
- **<code>&nbsp;&nbsp;1275</code>** [go-selfupdate](https://github.com/sanbornm/go-selfupdate) - Enable your Go applications to self update.
...
- **<code>&nbsp;68724</code>** [hugo](https://gohugo.io/) - Fast and Modern Static Website Engine.
- **<code>&nbsp;23376</code>** [croc](https://github.com/schollz/croc) - Easily and securely send files or folders from one computer to another.
- **<code>&nbsp;21041</code>** [restic](https://github.com/restic/restic) - De-duplicating backup program.
- **<code>&nbsp;18124</code>** [Seaweed File System](https://github.com/chrislusf/seaweedfs) - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
- **<code>&nbsp;17745</code>** [Gor](https://github.com/buger/gor) - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
- **<code>&nbsp;10014</code>** [Comcast](https://github.com/tylertreat/Comcast) - Simulate bad network connections.
- **<code>&nbsp;&nbsp;9337</code>** [toxiproxy](https://github.com/shopify/toxiproxy) - Proxy to simulate network and system conditions for automated tests.
...
- **<code>&nbsp;&nbsp;6561</code>** [drive](https://github.com/odeke-em/drive) - Google Drive client for the commandline.
- **<code>&nbsp;&nbsp;5272</code>** [nes](https://github.com/fogleman/nes) - Nintendo Entertainment System (NES) emulator written in Go.
...
- **<code>&nbsp;&nbsp;2822</code>** [blocky](https://github.com/0xERR0R/blocky) - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- **<code>&nbsp;&nbsp;1923</code>** [Documize](https://github.com/documize/community) - Modern wiki software that integrates data from SaaS tools.
...
- **<code>&nbsp;&nbsp;1287</code>** [Plik](https://github.com/root-gg/plik) - Plik is a temporary file upload system (Wetransfer like) in Go.
...
- **<code>&nbsp;&nbsp;1005</code>** [vFlow](https://github.com/VerizonDigital/vflow) - High-performance, scalable and reliable IPFIX, sFlow and Netflow collector.
- **<code>&nbsp;&nbsp;&nbsp;941</code>** [portal](https://github.com/SpatiumPortae/portal) - Portal is a quick and easy command-line file transfer utility from any computer to another.
...
- **<code>&nbsp;&nbsp;&nbsp;577</code>** [gocc](https://github.com/goccmack/gocc) - Gocc is a compiler kit for Go written in Go.
...
- **<code>&nbsp;&nbsp;&nbsp;390</code>** [woke](https://github.com/get-woke/woke) - Detect non-inclusive language in your source code.
...
- **<code>&nbsp;&nbsp;&nbsp;281</code>** [GoNB](https://github.com/janpfeifer/gonb) - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
- **<code>&nbsp;&nbsp;1910</code>** [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) - Go web framework benchmark.
...
- **<code>&nbsp;15652</code>** [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
- **<code>&nbsp;14619</code>** [GoBooks](https://github.com/dariubs/GoBooks) - A curated list of Go books.
...
- **<code>113859</code>** [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- **<code>&nbsp;27667</code>** [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md)
- **<code>&nbsp;14780</code>** [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst)
- **<code>&nbsp;14202</code>** [Uber](https://github.com/uber-go/guide/blob/master/style.md)
- **<code>&nbsp;12037</code>** [Thanos](https://thanos.io/tip/contributing/coding-style-guide.md/)
- **<code>&nbsp;&nbsp;8783</code>** [Sourcegraph](https://docs.sourcegraph.com/dev/background-information/languages/go)
- **<code>&nbsp;&nbsp;2962</code>** [Magnetico](https://github.com/boramalper/magnetico/wiki/magnetico-Design-Specification)
...
- **<code>113859</code>** [godoc.org](https://godoc.org/) - Documentation for open source Go packages.
- **<code>113859</code>** [go.dev](https://go.dev/) - A hub for Go developers.
- **<code>113859</code>** [Go Projects](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
- **<code>113859</code>** [Go Blog](https://blog.golang.org) - The official Go blog.
- **<code>113859</code>** [Go Proverbs](https://go-proverbs.github.io/) - Go Proverbs by Rob Pike.
- **<code>&nbsp;30496</code>** [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.
- **<code>&nbsp;26339</code>** [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- **<code>&nbsp;&nbsp;7026</code>** [Explore Go Libraries & Projects](https://kandi.openweaver.com/explore/go) - Discover & find a curated list of popular & new Go libraries, top authors, trending project kits, discussions, tutorials & learning resources on kandi.
...
- **<code>113859</code>** [A Comprehensive Guide to Structured Logging in Go](https://betterstack.com/community/guides/logging/logging-in-go/) - Delve deep into the world of structured logging in Go with a specific focus on recently accepted slog proposal which aims to bring high performance structured logging with levels to the standard library.
...
- **<code>113859</code>** [Go WebAssembly Tutorial - Building a Simple Calculator](https://tutorialedge.net/golang/go-webassembly-tutorial/)
- **<code>&nbsp;71024</code>** [Building Go Web Applications and Microservices Using Gin](https://semaphoreci.com/community/tutorials/building-go-web-applications-and-microservices-using-gin) - Get familiar with Gin and find out how it can help you reduce boilerplate code and build a request handling pipeline.
- **<code>&nbsp;42267</code>** [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - Golang ebook intro how to build a web app with golang.
- **<code>&nbsp;22696</code>** [go-patterns](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms.
- **<code>&nbsp;20049</code>** [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - Learn Go with test-driven development.
- **<code>&nbsp;20049</code>** [Golang Tutorial Guide](https://www.freecodecamp.org/news/golang-tutorial-list-free-courses-learn-go-programming-language/) - A List of Free Courses to Learn the Go Programming Language.
- **<code>&nbsp;17613</code>** [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) - Learn Go with thousands of examples, exercises, and quizzes.
- **<code>&nbsp;&nbsp;7775</code>** [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - Go's reference card.
- **<code>&nbsp;&nbsp;6430</code>** [Go By Example](https://gobyexample.com/) - Hands-on introduction to Go using annotated example programs.
- **<code>&nbsp;&nbsp;5381</code>** [go-clean-template](https://github.com/evrone/go-clean-template) - Clean Architecture template for Golang services.
...
- **<code>248217</code>** [The Go Developer Roadmap](https://roadmap.sh/golang) - A visual roadmap that new Go developers can follow through to help them learn Go.
