...
- **<code>&nbsp;&nbsp;1312</code>** [Oto](https://github.com/hajimehoshi/oto) - A low-level library to play sound on multiple platforms.
...
- **<code>&nbsp;&nbsp;5094</code>** [jwt-go](https://github.com/golang-jwt/jwt) - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- **<code>&nbsp;&nbsp;4817</code>** [oauth2](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- **<code>&nbsp;43232</code>** [go-ethereum](https://github.com/ethereum/go-ethereum) - Official Go implementation of the Ethereum protocol.
...
- **<code>&nbsp;&nbsp;4836</code>** [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - Simple and clean Telegram bot client.
...
- **<code>&nbsp;&nbsp;1007</code>** [Kelp](https://github.com/stellar/kelp) - official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies.
...
- **<code>&nbsp;&nbsp;8261</code>** [Task](https://github.com/go-task/task) - simple "Make" alternative.
...
- **<code>&nbsp;&nbsp;3631</code>** [mage](https://github.com/magefile/mage) - Mage is a make/rake-like build tool using Go.
...
- **<code>&nbsp;12597</code>** [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).
- **<code>&nbsp;&nbsp;9314</code>** [gocui](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.
- **<code>&nbsp;&nbsp;6090</code>** [lipgloss](https://github.com/charmbracelet/lipgloss) - Declaratively define styles for color, format and layout in the terminal.
- **<code>&nbsp;&nbsp;4972</code>** [go-prompt](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
- **<code>&nbsp;&nbsp;3932</code>** [pterm](https://github.com/pterm/pterm) - A library to beautify console output on every platform with many combinable components.
- **<code>&nbsp;&nbsp;3654</code>** [bubbles](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
- **<code>&nbsp;&nbsp;3423</code>** [progressbar](https://github.com/schollz/progressbar) - Basic thread-safe progress bar that works in every OS.
- **<code>&nbsp;&nbsp;2353</code>** [termdash](https://github.com/mum4k/termdash) - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui).
...
- **<code>&nbsp;&nbsp;&nbsp;405</code>** [yacspin](https://github.com/theckman/yacspin) - Yet Another CLi Spinner package, for working with terminal spinners.
...
- **<code>&nbsp;32870</code>** [cobra](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.
- **<code>&nbsp;20525</code>** [urfave/cli](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- **<code>&nbsp;&nbsp;2554</code>** [Dnote](https://github.com/dnote/dnote) - A simple command line notebook with multi-device sync.
...
- **<code>&nbsp;&nbsp;1112</code>** [ops](https://github.com/nanovms/ops) - Unikernel Builder/Orchestrator.
...
- **<code>&nbsp;23661</code>** [viper](https://github.com/spf13/viper) - Go configuration with fangs.
- **<code>&nbsp;&nbsp;6484</code>** [godotenv](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- **<code>&nbsp;&nbsp;3742</code>** [env](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).
- **<code>&nbsp;&nbsp;3286</code>** [ini](https://github.com/go-ini/ini) - Go package to read and write INI files.
- **<code>&nbsp;&nbsp;1941</code>** [koanf](https://github.com/knadh/koanf) - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- **<code>&nbsp;27142</code>** [drone](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.
- **<code>&nbsp;&nbsp;4258</code>** [CDS](https://github.com/ovh/cds) - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
- **<code>&nbsp;&nbsp;2901</code>** [woodpecker](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
...
- **<code>&nbsp;&nbsp;2099</code>** [roaring](https://github.com/RoaringBitmap/roaring) - Go package implementing compressed bitsets.
...
- **<code>&nbsp;&nbsp;3404</code>** [golang-set](https://github.com/deckarep/golang-set) - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- **<code>&nbsp;&nbsp;9193</code>** [bleve](https://github.com/blevesearch/bleve) - Modern text indexing library for go.
...
- **<code>&nbsp;12247</code>** [groupcache](https://github.com/golang/groupcache) - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
- **<code>&nbsp;&nbsp;6701</code>** [BigCache](https://github.com/allegro/bigcache) - Efficient key/value cache for gigabytes of data.
- **<code>&nbsp;&nbsp;2406</code>** [GCache](https://github.com/bluele/gcache) - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
- **<code>&nbsp;&nbsp;1809</code>** [fastcache](https://github.com/VictoriaMetrics/fastcache) - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
...
- **<code>&nbsp;49414</code>** [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
- **<code>&nbsp;34576</code>** [tidb](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.
- **<code>&nbsp;27573</code>** [cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
- **<code>&nbsp;25941</code>** [influxdb](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.
- **<code>&nbsp;22013</code>** [Milvus](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
- **<code>&nbsp;19510</code>** [dgraph](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- **<code>&nbsp;15389</code>** [dolt](https://github.com/dolthub/dolt) - Dolt – It's Git for Data.
- **<code>&nbsp;13917</code>** [rqlite](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
- **<code>&nbsp;13668</code>** [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
- **<code>&nbsp;12576</code>** [badger](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
- **<code>&nbsp;&nbsp;9032</code>** [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
- **<code>&nbsp;&nbsp;6773</code>** [bbolt](https://github.com/etcd-io/bbolt) - An embedded key/value database for Go.
- **<code>&nbsp;&nbsp;5804</code>** [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go.
...
- **<code>&nbsp;&nbsp;2951</code>** [godis](https://github.com/hdt3213/godis) - A Golang implemented high-performance Redis server and cluster.
...
- **<code>&nbsp;&nbsp;1207</code>** [lotusdb](https://github.com/flower-corp/lotusdb) - Fast k/v database compatible with lsm and b+tree.
...
- **<code>&nbsp;11987</code>** [migrate](https://github.com/golang-migrate/migrate) - Database migrations. CLI and Golang library.
- **<code>&nbsp;&nbsp;6439</code>** [bytebase](https://github.com/bytebase/bytebase) - Safe database schema change and version control for DevOps teams.
...
- **<code>&nbsp;&nbsp;3449</code>** [atlas](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- **<code>&nbsp;16612</code>** [vitess](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- **<code>&nbsp;&nbsp;4166</code>** [go-mysql](https://github.com/siddontang/go-mysql) - Go toolset to handle MySQL protocol and replication.
...
- **<code>&nbsp;&nbsp;8759</code>** [sqlc](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
- **<code>&nbsp;&nbsp;5942</code>** [Squirrel](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries.
...
- **<code>&nbsp;&nbsp;1944</code>** [goqu](https://github.com/doug-martin/goqu) - Idiomatic SQL builder and query library.
- **<code>&nbsp;&nbsp;1509</code>** [gendry](https://github.com/didi/gendry) - Non-invasive SQL builder and powerful data binder.
- **<code>&nbsp;&nbsp;1426</code>** [jet](https://github.com/go-jet/jet) - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
- **<code>&nbsp;&nbsp;&nbsp;678</code>** [Dotsql](https://github.com/gchaincl/dotsql) - Go library that helps you keep sql files in one place and use them with ease.
...
- **<code>&nbsp;13569</code>** [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.
- **<code>&nbsp;&nbsp;8224</code>** [pq](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.
- **<code>&nbsp;&nbsp;7543</code>** [pgx](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
- **<code>&nbsp;&nbsp;6781</code>** [go-sqlite3](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.
...
- **<code>&nbsp;17708</code>** [redis](https://github.com/redis/go-redis) - Redis client for Golang.
- **<code>&nbsp;&nbsp;9581</code>** [redigo](https://github.com/gomodule/redigo) - Redigo is a Go client for the Redis database.
- **<code>&nbsp;&nbsp;7554</code>** [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - Official MongoDB driver for the Go language.
- **<code>&nbsp;&nbsp;2450</code>** [gocql](https://gocql.github.io) - Go language driver for Apache Cassandra.
...
- **<code>&nbsp;&nbsp;1163</code>** [qmgo](https://github.com/qiniu/qmgo) - The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo.
...
- **<code>&nbsp;&nbsp;4207</code>** [now](https://github.com/jinzhu/now) - Now is a time toolkit for golang.
...
- **<code>&nbsp;&nbsp;1892</code>** [dateparse](https://github.com/araddon/dateparse) - Parse date's without knowing format in advance.
...
- **<code>106140</code>** [pjrpc](https://gitlab.com/pjrpc/pjrpc) - Golang JSON-RPC Server-Client with Protobuf spec.
- **<code>&nbsp;25287</code>** [go-kit](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- **<code>&nbsp;25140</code>** [go-zero](https://github.com/tal-tech/go-zero) - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- **<code>&nbsp;21148</code>** [Kratos](https://github.com/go-kratos/kratos) - A modular-designed and easy-to-use microservices framework in Go.
- **<code>&nbsp;20718</code>** [go-micro](https://github.com/micro/go-micro) - A distributed systems development framework.
- **<code>&nbsp;18576</code>** [grpc-go](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.
- **<code>&nbsp;13346</code>** [NATS](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.
- **<code>&nbsp;11844</code>** [micro](https://github.com/micro/micro) - A distributed systems runtime for the cloud and beyond.
- **<code>&nbsp;&nbsp;7681</code>** [rpcx](https://github.com/smallnest/rpcx) - Distributed pluggable RPC service framework like alibaba Dubbo.
- **<code>&nbsp;&nbsp;7312</code>** [raft](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.
- **<code>&nbsp;&nbsp;6125</code>** [Kitex](https://github.com/cloudwego/kitex) - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- **<code>&nbsp;&nbsp;5677</code>** [lura](https://github.com/luraproject/lura) - Ultra performant API Gateway framework with middlewares.
- **<code>&nbsp;&nbsp;4874</code>** [torrent](https://github.com/anacrolix/torrent) - BitTorrent client package.
...
- **<code>&nbsp;&nbsp;3227</code>** [gleam](https://github.com/chrislusf/gleam) - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
...
- **<code>&nbsp;&nbsp;1522</code>** [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- **<code>&nbsp;&nbsp;&nbsp;704</code>** [go-health](https://github.com/InVisionApp/go-health) - Library for enabling asynchronous dependency health checks in your service.
- **<code>&nbsp;&nbsp;&nbsp;680</code>** [gorpc](https://github.com/valyala/gorpc) - Simple, fast and scalable RPC library for high load.
- **<code>&nbsp;&nbsp;&nbsp;631</code>** [resgate](https://resgate.io/) - Realtime API Gateway for building REST, real time, and RPC APIs, where all clients are synchronized seamlessly.
...
- **<code>&nbsp;&nbsp;&nbsp;299</code>** [raft](https://github.com/etcd-io/raft) - Go implementation of the Raft consensus protocol, by CoreOS.
...
- **<code>&nbsp;12384</code>** [MailHog](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.
- **<code>&nbsp;&nbsp;2705</code>** [Mailpit](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
...
- **<code>&nbsp;&nbsp;&nbsp;640</code>** [chasquid](https://blitiri.com.ar/p/chasquid) - SMTP server written in Go.
...
- **<code>&nbsp;&nbsp;4114</code>** [goja](https://github.com/dop251/goja) - ECMAScript 5.1(+) implementation in Go.
- **<code>&nbsp;&nbsp;3938</code>** [expr](https://github.com/antonmedv/expr) - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
...
- **<code>&nbsp;&nbsp;1716</code>** [cel-go](https://github.com/google/cel-go) - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
- **<code>&nbsp;&nbsp;&nbsp;641</code>** [gval](https://github.com/PaesslerAG/gval) - A highly customizable expression language written in Go.
...
- **<code>&nbsp;&nbsp;8064</code>** [errors](https://github.com/pkg/errors) - Package that provides simple error handling primitives.
...
- **<code>&nbsp;&nbsp;5283</code>** [afero](https://github.com/spf13/afero) - FileSystem Abstraction System for Go.
- **<code>&nbsp;&nbsp;5181</code>** [pdfcpu](https://github.com/pdfcpu/pdfcpu) - PDF processor.
...
- **<code>&nbsp;&nbsp;5266</code>** [decimal](https://github.com/shopspring/decimal) - Arbitrary-precision fixed-point decimal numbers.
- **<code>&nbsp;&nbsp;4624</code>** [ticker](https://github.com/achannarasappa/ticker) - Terminal stock watcher and stock position tracker.
- **<code>&nbsp;&nbsp;1342</code>** [go-money](https://github.com/rhymond/go-money) - Implementation of Fowler's Money pattern.
- **<code>&nbsp;&nbsp;&nbsp;933</code>** [bbgo](https://github.com/c9s/bbgo) - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- **<code>&nbsp;&nbsp;1031</code>** [raylib-go](https://github.com/gen2brain/raylib-go) - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- **<code>&nbsp;&nbsp;&nbsp;355</code>** [Harfang3D](https://github.com/harfang3d/harfang3d) - 3D engine for the Go language, works on Windows and Linux ([Harfang on Go.dev](https://github.com/harfang3d/harfang-go)).
...
- **<code>&nbsp;12051</code>** [gopherjs](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.
...
- **<code>&nbsp;10810</code>** [ants](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
- **<code>&nbsp;&nbsp;7111</code>** [conc](https://github.com/sourcegraph/conc) - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- **<code>&nbsp;21000</code>** [fyne](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- **<code>&nbsp;&nbsp;9916</code>** [qt](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
- **<code>&nbsp;&nbsp;3239</code>** [gio](https://gioui.org) - Gio is a library for writing cross-platform immediate mode GUI-s in Go. Gio supports all the major platforms: Linux, macOS, Windows, Android, iOS, FreeBSD, OpenBSD and WebAssembly.
...
- **<code>&nbsp;&nbsp;2855</code>** [systray](https://github.com/getlantern/systray) - Cross platform Go library to place an icon and menu in the notification area.
...
- **<code>&nbsp;&nbsp;5653</code>** [gocv](https://github.com/hybridgroup/gocv) - Go package for computer vision using OpenCV 3.3+.
...
- **<code>&nbsp;&nbsp;2298</code>** [gowitness](https://github.com/sensepost/gowitness) - Screenshoting webpages using go and headless chrome on command line.
...
- **<code>&nbsp;&nbsp;8365</code>** [gobot](https://github.com/hybridgroup/gobot/) - Gobot is a framework for robotics, physical computing, and the Internet of Things.
...
- **<code>&nbsp;&nbsp;2115</code>** [mainflux](https://github.com/Mainflux/mainflux) - Industrial IoT Messaging and Device Management Server.
- **<code>&nbsp;&nbsp;1092</code>** [ekuiper](https://github.com/lf-edge/ekuiper) - Lightweight data stream processing engine for IoT edge.
...
- **<code>&nbsp;&nbsp;3761</code>** [gocron](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
- **<code>&nbsp;&nbsp;1360</code>** [go-quartz](https://github.com/reugn/go-quartz) - Simple, zero-dependency scheduling library for Go.
...
- **<code>&nbsp;12662</code>** [GJSON](https://github.com/tidwall/gjson) - Get a JSON value with one line of code.
...
- **<code>&nbsp;&nbsp;1960</code>** [fastjson](https://github.com/valyala/fastjson) - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
...
- **<code>&nbsp;23070</code>** [logrus](https://github.com/Sirupsen/logrus) - Structured logger for Go.
- **<code>&nbsp;19279</code>** [zap](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
- **<code>&nbsp;&nbsp;8669</code>** [zerolog](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
- **<code>&nbsp;&nbsp;&nbsp;245</code>** [tint](https://github.com/lmittmann/tint) - A slog.Handler that writes tinted logs.
...
- **<code>&nbsp;&nbsp;2186</code>** [gosseract](https://github.com/otiai10/gosseract) - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
...
- **<code>&nbsp;10208</code>** [sarama](https://github.com/Shopify/sarama) - Go library for Apache Kafka.
- **<code>&nbsp;&nbsp;7270</code>** [Centrifugo](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
- **<code>&nbsp;&nbsp;7174</code>** [gorush](https://github.com/appleboy/gorush) - Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).
...
- **<code>&nbsp;&nbsp;6546</code>** [Asynq](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
- **<code>&nbsp;&nbsp;6469</code>** [Benthos](https://github.com/Jeffail/benthos) - A message streaming bridge between a range of protocols.
- **<code>&nbsp;&nbsp;5968</code>** [Watermill](https://github.com/ThreeDotsLabs/watermill) - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- **<code>&nbsp;&nbsp;4675</code>** [NATS Go Client](https://github.com/nats-io/nats) - Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library.
- **<code>&nbsp;&nbsp;4066</code>** [Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- **<code>&nbsp;&nbsp;2843</code>** [APNs2](https://github.com/sideshow/apns2) - HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps.
...
- **<code>&nbsp;&nbsp;&nbsp;947</code>** [amqp](https://github.com/rabbitmq/amqp091-go) - Go RabbitMQ Client Library.
...
- **<code>&nbsp;15644</code>** [excelize](https://github.com/xuri/excelize) - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- **<code>&nbsp;&nbsp;4225</code>** [fx](https://github.com/uber-go/fx) - A dependency injection based application framework for Go (built on top of dig).
...
- **<code>&nbsp;41068</code>** [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful.
- **<code>&nbsp;&nbsp;2817</code>** [ardanlabs/service](https://github.com/ardanlabs/service) - A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications.
...
- **<code>106140</code>** [go-formatter](https://gitlab.com/tymonx/go-formatter) - Implements **replacement fields** surrounded by curly braces `{}` format strings.
...
- **<code>&nbsp;&nbsp;9320</code>** [gopsutil](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- **<code>&nbsp;&nbsp;3228</code>** [gofakeit](https://github.com/brianvoe/gofakeit) - Random data generator written in go.
- **<code>&nbsp;&nbsp;1838</code>** [go-resiliency](https://github.com/eapache/go-resiliency) - Resiliency patterns for golang.
- **<code>&nbsp;&nbsp;1828</code>** [base64Captcha](https://github.com/mojocn/base64Captcha) - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
- **<code>&nbsp;&nbsp;&nbsp;984</code>** [slug](https://github.com/gosimple/slug) - URL-friendly slugify with multiple languages support.
...
- **<code>&nbsp;&nbsp;2194</code>** [gojieba](https://github.com/yanyiwu/gojieba) - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.
...
- **<code>&nbsp;&nbsp;1444</code>** [go-pinyin](https://github.com/mozillazg/go-pinyin) - CN Hanzi to Hanyu Pinyin converter.
...
- **<code>&nbsp;19953</code>** [fasthttp](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- **<code>&nbsp;13428</code>** [kcptun](https://github.com/xtaci/kcptun) - Extremely simple & fast udp tunnel based on KCP protocol.
- **<code>&nbsp;11523</code>** [webrtc](https://github.com/pions/webrtc) - A pure Go implementation of the WebRTC API.
- **<code>&nbsp;&nbsp;8512</code>** [quic-go](https://github.com/lucas-clemente/quic-go) - An implementation of the QUIC protocol in pure Go.
- **<code>&nbsp;&nbsp;7922</code>** [gnet](https://github.com/panjf2000/gnet) - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
- **<code>&nbsp;&nbsp;7131</code>** [dns](https://github.com/miekg/dns) - Go library for working with DNS.
- **<code>&nbsp;&nbsp;5756</code>** [gopacket](https://github.com/google/gopacket) - Go library for packet processing with libpcap bindings.
...
- **<code>&nbsp;&nbsp;3651</code>** [netpoll](https://github.com/cloudwego/netpoll) - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- **<code>&nbsp;&nbsp;&nbsp;705</code>** [easytcp](https://github.com/DarthPestilane/easytcp) - A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful.
...
- **<code>&nbsp;&nbsp;&nbsp;406</code>** [gws](https://github.com/lxzan/gws) - High-Performance WebSocket Server & Client With AsyncIO Supporting .
...
- **<code>&nbsp;&nbsp;8157</code>** [resty](https://github.com/go-resty/resty) - Simple HTTP and REST client for Go inspired by Ruby rest-client.
- **<code>&nbsp;&nbsp;3504</code>** [req](https://github.com/imroc/req) - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- **<code>&nbsp;&nbsp;1103</code>** [requests](https://github.com/carlmjohnson/requests) - HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools.
...
- **<code>&nbsp;33228</code>** [GORM](https://github.com/go-gorm/gorm) - The fantastic ORM library for Golang, aims to be developer friendly.
- **<code>&nbsp;13887</code>** [ent](https://github.com/facebook/ent) - An entity framework for Go. Simple, yet powerful ORM for modeling and querying data.
- **<code>&nbsp;&nbsp;5938</code>** [SQLBoiler](https://github.com/volatiletech/sqlboiler) - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- **<code>&nbsp;&nbsp;2901</code>** [XORM](https://gitea.com/xorm/xorm) - Simple and powerful ORM for Go. (Support: MySQL, MyMysql, PostgreSQL, Tidb, SQLite3, MsSql and Oracle).
...
- **<code>113445</code>** [go modules](https://golang.org/cmd/go/#hdr-Modules__module_versions__and_more) - Modules are the unit of source code interchange and versioning. The go command has direct support for working with modules, including recording and resolving dependencies on other modules.
...
- **<code>&nbsp;18065</code>** [jaeger](https://github.com/jaegertracing/jaeger) - A distributed tracing system.
- **<code>&nbsp;&nbsp;4765</code>** [pixie](https://github.com/pixie-labs/pixie) - No instrumentation tracing for Golang applications via eBPF.
...
- **<code>&nbsp;&nbsp;6756</code>** [gonum](https://github.com/gonum/gonum) - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.
...
- **<code>&nbsp;&nbsp;2492</code>** [gonum/plot](https://github.com/gonum/plot) - gonum/plot provides an API for building and drawing plots in Go.
...
- **<code>113445</code>** [autocert](https://godoc.org/golang.org/x/crypto/acme/autocert) - Auto provision Let's Encrypt certificates and start a TLS server.
- **<code>&nbsp;13882</code>** [age](https://github.com/FiloSottile/age) - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
- **<code>&nbsp;&nbsp;6369</code>** [lego](https://github.com/go-acme/lego) - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- **<code>&nbsp;12487</code>** [jsoniter](https://github.com/json-iterator/go) - High-performance 100% compatible drop-in replacement of "encoding/json".
...
- **<code>&nbsp;&nbsp;7025</code>** [mapstructure](https://github.com/mitchellh/mapstructure) - Go library for decoding generic map values into native Go structures.
...
- **<code>&nbsp;48507</code>** [Caddy](https://github.com/caddyserver/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- **<code>&nbsp;44171</code>** [etcd](https://github.com/coreos/etcd) - Highly-available key value store for shared configuration and service discovery.
- **<code>&nbsp;40294</code>** [minio](https://github.com/minio/minio) - Minio is a distributed object storage server.
- **<code>&nbsp;23685</code>** [nsq](https://nsq.io/) - A realtime distributed messaging platform.
...
- **<code>&nbsp;&nbsp;2594</code>** [flipt](https://github.com/markphelps/flipt) - A self contained feature flag solution written in Go and Vue.js
...
- **<code>&nbsp;&nbsp;2818</code>** [quicktemplate](https://github.com/valyala/quicktemplate) - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
...
- **<code>&nbsp;&nbsp;&nbsp;741</code>** [fasttemplate](https://github.com/valyala/fasttemplate) - Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/).
...
- Testing Frameworks
  ...
  - **<code>113445</code>** [testmd](https://godoc.org/github.com/tvastar/test/cmd/testmd) - Convert markdown snippets into testable go code.
  - **<code>&nbsp;20317</code>** [Testify](https://github.com/stretchr/testify) - Sacred extension to the standard go testing package.
  - **<code>&nbsp;&nbsp;7853</code>** [GoConvey](https://github.com/smartystreets/goconvey/) - BDD-style framework with web UI and live reload.
  - **<code>&nbsp;&nbsp;3646</code>** [go-cmp](https://github.com/google/go-cmp) - Package for comparing Go values in tests.
  - **<code>&nbsp;&nbsp;2331</code>** [testcontainers-go](https://github.com/testcontainers/testcontainers-go) - A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.
  - **<code>&nbsp;&nbsp;2274</code>** [httpexpect](https://github.com/gavv/httpexpect) - Concise, declarative, and easy to use end-to-end HTTP and REST API testing.
...
- Mock
  ...
  - **<code>106140</code>** [genmock](https://gitlab.com/so_literate/genmock) - Go mocking system with code generator for building calls of the interface methods.
  - **<code>&nbsp;&nbsp;9050</code>** [gomock](https://github.com/golang/mock) - Mocking framework for the Go programming language.
  - **<code>&nbsp;&nbsp;5404</code>** [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - Mock SQL driver for testing database interactions.
  - **<code>&nbsp;&nbsp;4869</code>** [mockery](https://github.com/vektra/mockery) - Tool to generate Go interfaces.
  ...
  - **<code>&nbsp;&nbsp;1718</code>** [httpmock](https://github.com/jarcoal/httpmock) - Easy mocking of HTTP responses from external resources.
...
- Selenium and browser control tools.
  ...
  - **<code>&nbsp;&nbsp;9389</code>** [chromedp](https://github.com/knq/chromedp) - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- **<code>113445</code>** [github_flavored_markdown](https://godoc.org/github.com/shurcooL/github_flavored_markdown) - GitHub Flavored Markdown renderer (using blackfriday) with fenced code block highlighting, clickable header anchor links.
...
- **<code>&nbsp;&nbsp;6084</code>** [sh](https://github.com/mvdan/sh) - Shell parser and formatter.
- **<code>&nbsp;&nbsp;2222</code>** [gofeed](https://github.com/mmcdole/gofeed) - Parse RSS and Atom feeds in Go.
...
- **<code>&nbsp;&nbsp;2759</code>** [bluemonday](https://github.com/microcosm-cc/bluemonday) - HTML Sanitizer.
- **<code>&nbsp;&nbsp;&nbsp;&nbsp;57</code>** [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) - A sanitization-based swear filter for Go.

### Scrapers

- **<code>&nbsp;20264</code>** [colly](https://github.com/asciimoo/colly) - Fast and Elegant Scraping Framework for Gophers.
- **<code>&nbsp;12825</code>** [GoQuery](https://github.com/PuerkitoBio/goquery) - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
- **<code>&nbsp;&nbsp;1067</code>** [xurls](https://github.com/mvdan/xurls) - Extract urls from text.
...
- **<code>&nbsp;&nbsp;9578</code>** [github](https://github.com/google/go-github) - Go library for accessing the GitHub REST API v3.
...
- **<code>&nbsp;53674</code>** [fzf](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.
- **<code>&nbsp;37726</code>** [dive](https://github.com/wagoodman/dive) - A tool for exploring each layer in a Docker image.
...
- **<code>&nbsp;14027</code>** [sqlx](https://github.com/jmoiron/sqlx) - provides a set of extensions on top of the excellent built-in database/sql package.
- **<code>&nbsp;12769</code>** [lo](https://github.com/samber/lo) - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
- **<code>&nbsp;11950</code>** [goreleaser](https://github.com/goreleaser/goreleaser) - Deliver Go binaries as fast and easily as possible.
- **<code>&nbsp;10344</code>** [wuzz](https://github.com/asciimoo/wuzz) - Interactive cli tool for HTTP inspection.
- **<code>&nbsp;&nbsp;8166</code>** [usql](https://github.com/knq/usql) - usql is a universal command-line interface for SQL databases.
...
- **<code>&nbsp;&nbsp;2742</code>** [lancet](https://github.com/duke-git/lancet) - A comprehensive, efficient, and reusable util function library of go.
...
- **<code>&nbsp;&nbsp;1804</code>** [retry-go](https://github.com/avast/retry-go) - Simple library for retry mechanism.
...
- **<code>&nbsp;&nbsp;1179</code>** [mimetype](https://github.com/gabriel-vasile/mimetype) - Package for MIME type detection based on magic numbers.
- **<code>&nbsp;&nbsp;1077</code>** [circuitbreaker](https://github.com/rubyist/circuitbreaker) - Circuit Breakers in Go.
- **<code>&nbsp;&nbsp;&nbsp;969</code>** [scany](https://github.com/georgysavva/scany) - Library for scanning data from a database into Go structs and more.
...
- **<code>&nbsp;&nbsp;4479</code>** [uuid](https://github.com/google/uuid) - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- **<code>&nbsp;&nbsp;3455</code>** [xid](https://github.com/rs/xid) - Xid is a globally unique id generator library, ready to be safely used directly in your server code.
...
- **<code>&nbsp;13694</code>** [validator](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- **<code>&nbsp;&nbsp;3284</code>** [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
- **<code>106140</code>** [cli](https://gitlab.com/gitlab-org/cli) - An open-source GitLab command line tool bringing GitLab's cool features to your command line.
...
- **<code>&nbsp;70660</code>** [Gin](https://github.com/gin-gonic/gin) - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- **<code>&nbsp;27711</code>** [Fiber](https://github.com/gofiber/fiber) - An Express.js inspired web framework build on Fasthttp.
- **<code>&nbsp;26263</code>** [Echo](https://github.com/labstack/echo) - High performance, minimalist Go web framework.
- **<code>&nbsp;12955</code>** [Revel](https://github.com/revel/revel) - High-productivity web framework for the Go language.
- **<code>&nbsp;&nbsp;9821</code>** [GoFrame](https://github.com/gogf/gf) - GoFrame is a modular, full-featured and production-ready application development framework of golang.
- **<code>&nbsp;&nbsp;7776</code>** [Buffalo](https://gobuffalo.io) - Bringing the productivity of Rails to Go!
...
- **<code>&nbsp;&nbsp;4040</code>** [Hertz](https://github.com/cloudwego/hertz) - A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.
...
- **<code>&nbsp;&nbsp;1821</code>** [render](https://github.com/unrolled/render) - Go package for easily rendering JSON, XML, and HTML template responses.
...
- **<code>&nbsp;18934</code>** [mux](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.
- **<code>&nbsp;15600</code>** [httprouter](https://github.com/julienschmidt/httprouter) - High performance router. Use this and the standard http handlers to form a very high performance web framework.
- **<code>&nbsp;14933</code>** [chi](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.
...
- **<code>&nbsp;13278</code>** [tinygo](https://github.com/tinygo-org/tinygo) - Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.
...
- **<code>&nbsp;&nbsp;3523</code>** [Cosign](https://github.com/sigstore/cosign) - Container Signing, Verification and Storage in an OCI registry.
...
- **<code>113445</code>** [goimports](https://godoc.org/golang.org/x/tools/cmd/goimports) - Tool to fix (add, remove) your Go imports automatically.
...
- **<code>&nbsp;&nbsp;1487</code>** [GoPlantUML](https://github.com/jfeliu007/goplantuml) - Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them.
...
- **<code>&nbsp;&nbsp;4647</code>** [gotests](https://github.com/cweill/gotests) - Generate Go tests from your source code.
...
- **<code>100759</code>** [kubernetes](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
- **<code>&nbsp;66423</code>** [Moby](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems.
- **<code>&nbsp;44138</code>** [traefik](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.
- **<code>&nbsp;42735</code>** [Gogs](https://gogs.io/) - A Self Hosted Git Service in the Go Programming Language.
- **<code>&nbsp;37841</code>** [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.
- **<code>&nbsp;37841</code>** [gitea-github-migrator](https://git.jonasfranz.software/JonasFranzDEV/gitea-github-migrator) - Migrate all your GitHub repositories, issues, milestones and labels to your Gitea instance.
- **<code>&nbsp;21646</code>** [Vegeta](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!
- **<code>&nbsp;16058</code>** [Hey](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.
- **<code>&nbsp;14568</code>** [Packer](https://github.com/mitchellh/packer) - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
- **<code>&nbsp;&nbsp;9392</code>** [Mizu](https://github.com/up9inc/mizu) - API traffic viewer for Kubernetes enabling you to view all API communication between microservices, multiprotocol support: HTTP1.1, HTTP/2, AMQP, Kafka, Redis.
- **<code>&nbsp;&nbsp;9182</code>** [webhook](https://github.com/adnanh/webhook) - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
- **<code>&nbsp;&nbsp;8684</code>** [GVM](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.
...
- **<code>&nbsp;&nbsp;5504</code>** [KubeVela](https://github.com/kubevela/kubevela) - Cloud native application delivery.
...
- **<code>&nbsp;&nbsp;4250</code>** [script](https://github.com/bitfield/script) - Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.
...
- **<code>&nbsp;&nbsp;1816</code>** [s5cmd](https://github.com/peak/s5cmd) - Blazing fast S3 and local filesystem execution tool.
...
- **<code>&nbsp;&nbsp;&nbsp;266</code>** [gobrew](https://github.com/kevincobain2000/gobrew) - Go version manager. Super simple tool to install and manage Go versions. Install go without root. Gobrew doesn't require shell rehash.
...
- **<code>&nbsp;68459</code>** [hugo](https://gohugo.io/) - Fast and Modern Static Website Engine.
- **<code>&nbsp;23262</code>** [croc](https://github.com/schollz/croc) - Easily and securely send files or folders from one computer to another.
- **<code>&nbsp;20891</code>** [restic](https://github.com/restic/restic) - De-duplicating backup program.
- **<code>&nbsp;18016</code>** [Seaweed File System](https://github.com/chrislusf/seaweedfs) - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
- **<code>&nbsp;17703</code>** [Gor](https://github.com/buger/gor) - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.
...
- **<code>&nbsp;&nbsp;2841</code>** [zs](https://git.mills.io/prologic/zs) - an extremely minimal static site generator.
- **<code>&nbsp;&nbsp;2784</code>** [blocky](https://github.com/0xERR0R/blocky) - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- **<code>&nbsp;&nbsp;1319</code>** [Docker](https://www.docker.com/) - Open platform for distributed applications for developers and sysadmins.
...
- **<code>&nbsp;&nbsp;&nbsp;270</code>** [GoNB](https://github.com/janpfeifer/gonb) - Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab).
...
- **<code>&nbsp;&nbsp;5215</code>** [100 Go Mistakes: How to Avoid Them](https://www.manning.com/books/100-go-mistakes-how-to-avoid-them)
- **<code>&nbsp;&nbsp;2525</code>** [Build an Orchestrator in Go](https://www.manning.com/books/build-an-orchestrator-in-go)
...
- **<code>&nbsp;15600</code>** [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
...
- **<code>113445</code>** [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
- **<code>&nbsp;27573</code>** [CockroachDB](https://github.com/cockroachdb/cockroach/blob/master/docs/style.md)
- **<code>&nbsp;14742</code>** [Hyperledger](https://github.com/hyperledger/fabric/blob/release-1.4/docs/source/style-guides/go-style.rst)
- **<code>&nbsp;14119</code>** [Uber](https://github.com/uber-go/guide/blob/master/style.md)
- **<code>&nbsp;11981</code>** [Thanos](https://thanos.io/tip/contributing/coding-style-guide.md/)
- **<code>&nbsp;&nbsp;8708</code>** [Sourcegraph](https://docs.sourcegraph.com/dev/background-information/languages/go)
...
- **<code>113445</code>** [godoc.org](https://godoc.org/) - Documentation for open source Go packages.
- **<code>113445</code>** [go.dev](https://go.dev/) - A hub for Go developers.
- **<code>113445</code>** [Go Projects](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
- **<code>113445</code>** [Go Blog](https://blog.golang.org) - The official Go blog.
- **<code>113445</code>** [Go Proverbs](https://go-proverbs.github.io/) - Go Proverbs by Rob Pike.
- **<code>&nbsp;30460</code>** [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.
- **<code>&nbsp;26191</code>** [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- **<code>&nbsp;&nbsp;6996</code>** [Explore Go Libraries & Projects](https://kandi.openweaver.com/explore/go) - Discover & find a curated list of popular & new Go libraries, top authors, trending project kits, discussions, tutorials & learning resources on kandi.
...
- **<code>&nbsp;&nbsp;&nbsp;&nbsp;21</code>** [Golang News](https://golangnews.com) - Links and news about Go programming.
...
- **<code>113445</code>** [Go WebAssembly Tutorial - Building a Simple Calculator](https://tutorialedge.net/golang/go-webassembly-tutorial/)
- **<code>&nbsp;70660</code>** [Building Go Web Applications and Microservices Using Gin](https://semaphoreci.com/community/tutorials/building-go-web-applications-and-microservices-using-gin) - Get familiar with Gin and find out how it can help you reduce boilerplate code and build a request handling pipeline.
- **<code>&nbsp;42231</code>** [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - Golang ebook intro how to build a web app with golang.
- **<code>&nbsp;22607</code>** [go-patterns](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms.
- **<code>&nbsp;19905</code>** [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - Learn Go with test-driven development.
- **<code>&nbsp;19905</code>** [Golang Tutorial Guide](https://www.freecodecamp.org/news/golang-tutorial-list-free-courses-learn-go-programming-language/) - A List of Free Courses to Learn the Go Programming Language.
- **<code>&nbsp;17567</code>** [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) - Learn Go with thousands of examples, exercises, and quizzes.
- **<code>&nbsp;&nbsp;7728</code>** [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - Go's reference card.
- **<code>&nbsp;&nbsp;6416</code>** [Go By Example](https://gobyexample.com/) - Hands-on introduction to Go using annotated example programs.
- **<code>&nbsp;&nbsp;5339</code>** [go-clean-template](https://github.com/evrone/go-clean-template) - Clean Architecture template for Golang services.
...
- **<code>&nbsp;&nbsp;&nbsp;781</code>** [Learning Go by examples](https://dev.to/aurelievache/learning-go-by-examples-introduction-448n) - Series of articles in order to learn Golang language by concrete applications as example.
...
- **<code>246591</code>** [The Go Developer Roadmap](https://roadmap.sh/golang) - A visual roadmap that new Go developers can follow through to help them learn Go.
