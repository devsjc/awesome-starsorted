...
- **<code>&nbsp;68510</code>** [Ollama](https://github.com/jmorganca/ollama) - Run large language models locally.
...
- **<code>&nbsp;13007</code>** [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).
...
- **<code>&nbsp;&nbsp;5213</code>** [go-prompt](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
- **<code>&nbsp;&nbsp;&nbsp;405</code>** [Bencher](https://bencher.dev/) - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
- **<code>&nbsp;53151</code>** [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
...
- **<code>&nbsp;27362</code>** [Milvus](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
...
- **<code>&nbsp;14004</code>** [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
- **<code>&nbsp;13453</code>** [badger](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
- **<code>&nbsp;10988</code>** [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.
...
- **<code>&nbsp;10229</code>** [bytebase](https://github.com/bytebase/bytebase) - Safe database schema change and version control for DevOps teams.
...
- **<code>&nbsp;&nbsp;5135</code>** [atlas](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- **<code>&nbsp;&nbsp;9596</code>** [pgx](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
...
- **<code>122306</code>** [pjrpc](https://gitlab.com/pjrpc/pjrpc) - Golang JSON-RPC Server-Client with Protobuf spec.
- **<code>&nbsp;27818</code>** [go-zero](https://github.com/tal-tech/go-zero) - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
...
- **<code>&nbsp;&nbsp;6370</code>** [pdfcpu](https://github.com/pdfcpu/pdfcpu) - PDF processor.
...
- **<code>&nbsp;&nbsp;&nbsp;313</code>** [go-functional](https://github.com/BooleanCat/go-functional) - Functional programming in Go using generics
...
- **<code>&nbsp;10007</code>** [Ebitengine](https://github.com/hajimehoshi/ebiten) - dead simple 2D game engine in Go.
...
- **<code>&nbsp;&nbsp;&nbsp;511</code>** [Harfang3D](https://github.com/harfang3d/harfang3d) - 3D engine for the Go language, works on Windows and Linux ([Harfang on Go.dev](https://github.com/harfang3d/harfang-go)).
...
- **<code>120225</code>** [oversight](https://pkg.go.dev/cirello.io/oversight) - Oversight is a complete implementation of the Erlang supervision trees.
...
- **<code>&nbsp;23537</code>** [fyne](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- **<code>&nbsp;&nbsp;3479</code>** [gio](https://gioui.org) - Gio is a library for writing cross-platform immediate mode GUI-s in Go. Gio supports all the major platforms: Linux, macOS, Windows, Android, iOS, FreeBSD, OpenBSD and WebAssembly.
...
- **<code>&nbsp;&nbsp;5009</code>** [gocron](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
...
- **<code>122306</code>** [go-formatter](https://gitlab.com/tymonx/go-formatter) - Implements **replacement fields** surrounded by curly braces `{}` format strings.
...
- **<code>&nbsp;35694</code>** [GORM](https://github.com/go-gorm/gorm) - The fantastic ORM library for Golang, aims to be developer friendly.
...
- **<code>&nbsp;10346</code>** [XORM](https://gitea.com/xorm/xorm) - Simple and powerful ORM for Go. (Support: MySQL, MyMysql, PostgreSQL, Tidb, SQLite3, MsSql and Oracle).
...
- **<code>120225</code>** [go modules](https://golang.org/cmd/go/#hdr-Modules__module_versions__and_more) - Modules are the unit of source code interchange and versioning. The go command has direct support for working with modules, including recording and resolving dependencies on other modules.
...
- **<code>&nbsp;19609</code>** [jaeger](https://github.com/jaegertracing/jaeger) - A distributed tracing system.
...
- **<code>120225</code>** [autocert](https://pkg.go.dev/golang.org/x/crypto/acme/autocert) - Auto provision Let's Encrypt certificates and start a TLS server.
...
- **<code>&nbsp;46545</code>** [etcd](https://github.com/etcd-io/etcd) - Highly-available key value store for shared configuration and service discovery.
- **<code>&nbsp;44647</code>** [minio](https://github.com/minio/minio) - Minio is a distributed object storage server.
- **<code>&nbsp;24630</code>** [nsq](https://nsq.io/) - A realtime distributed messaging platform.
...
- **<code>&nbsp;&nbsp;1099</code>** [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) - A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.
...
- **<code>&nbsp;&nbsp;6690</code>** [templ](https://github.com/a-h/templ) - A HTML templating language that has great developer tooling.
...
- **<code>122306</code>** [genmock](https://gitlab.com/so_literate/genmock) - Go mocking system with code generator for building calls of the interface methods.
...
- **<code>&nbsp;10469</code>** [chromedp](https://github.com/knq/chromedp) - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
- **<code>&nbsp;15580</code>** [lo](https://github.com/samber/lo) - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- **<code>122306</code>** [cli](https://gitlab.com/gitlab-org/cli) - An open-source GitLab command line tool bringing GitLab's cool features to your command line.
...
- **<code>&nbsp;31655</code>** [Fiber](https://github.com/gofiber/fiber) - An Express.js inspired web framework build on Fasthttp.
- **<code>&nbsp;30978</code>** [Beego](https://github.com/beego/beego) - beego is an open-source, high-performance web framework for the Go programming language.
...
- **<code>&nbsp;&nbsp;4144</code>** [Cosign](https://github.com/sigstore/cosign) - Container Signing, Verification and Storage in an OCI registry.
...
- **<code>120225</code>** [goimports](https://pkg.go.dev/golang.org/x/tools/cmd/goimports) - Tool to fix (add, remove) your Go imports automatically.
...
- **<code>&nbsp;67842</code>** [Moby](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems.
- **<code>&nbsp;44280</code>** [Gogs](https://gogs.io/) - A Self Hosted Git Service in the Go Programming Language.
- **<code>&nbsp;42387</code>** [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.
- **<code>&nbsp;42387</code>** [gitea-github-migrator](https://git.jonasfranz.software/JonasFranzDEV/gitea-github-migrator) - Migrate all your GitHub repositories, issues, milestones and labels to your Gitea instance.
- **<code>&nbsp;28497</code>** [minikube](https://github.com/kubernetes/minikube) - Run Kubernetes locally.
- **<code>&nbsp;26654</code>** [k3s](https://github.com/k3s-io/k3s) - Lightweight Kubernetes.
- **<code>&nbsp;23603</code>** [k6](https://github.com/grafana/k6) - A modern load testing tool, using Go and JavaScript.
...
- **<code>&nbsp;72883</code>** [hugo](https://gohugo.io/) - Fast and Modern Static Website Engine.
...
- **<code>&nbsp;&nbsp;2553</code>** [Wave Terminal](https://waveterm.dev) - Wave is an open-source, AI-native terminal built for seamless developer workflows with inline rendering, a modern UI, and persistent sessions.
...
- **<code>&nbsp;16343</code>** [Building Web Apps With Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/)
...
- **<code>120225</code>** [GitLab](https://docs.gitlab.com/ee/development/go_guide/)
...
- **<code>&nbsp;12645</code>** [Thanos](https://thanos.io/tip/contributing/coding-style-guide.md/)
...
- **<code>120225</code>** [pkg.go.dev](https://pkg.go.dev/) - Documentation for open source Go packages.
- **<code>120225</code>** [Go Projects](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.
...
- **<code>120225</code>** [A Comprehensive Guide to Structured Logging in Go](https://betterstack.com/community/guides/logging/logging-in-go/) - Delve deep into the world of structured logging in Go with a specific focus on recently accepted slog proposal which aims to bring high performance structured logging with levels to the standard library.
...
- **<code>120225</code>** [Go WebAssembly Tutorial - Building a Simple Calculator](https://tutorialedge.net/golang/go-webassembly-tutorial/)
- **<code>&nbsp;75901</code>** [Building Go Web Applications and Microservices Using Gin](https://semaphoreci.com/community/tutorials/building-go-web-applications-and-microservices-using-gin) - Get familiar with Gin and find out how it can help you reduce boilerplate code and build a request handling pipeline.
...
- **<code>&nbsp;21371</code>** [Golang Tutorial Guide](https://www.freecodecamp.org/news/golang-tutorial-list-free-courses-learn-go-programming-language/) - A List of Free Courses to Learn the Go Programming Language.
...
- **<code>277483</code>** [The Go Developer Roadmap](https://roadmap.sh/golang) - A visual roadmap that new Go developers can follow through to help them learn Go.
