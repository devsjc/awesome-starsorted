...
* **<code>&nbsp;&nbsp;5831</code>** [Pachyderm](http://pachyderm.io/) - Pachyderm is a data storage platform built on Docker and Kubernetes to provide reproducible data processing and analysis.
...
* **<code>&nbsp;34968</code>** [Apache Spark Streaming](https://spark.apache.org/docs/latest/streaming-programming-guide.html) - framework for stream processing, part of Spark.
* **<code>&nbsp;34968</code>** [Apache Spark](http://spark.apache.org/) - framework for in-memory cluster computing.
* **<code>&nbsp;24019</code>** [Ray](https://github.com/ray-project/ray) - A fast and simple framework for building and running distributed applications. 
* **<code>&nbsp;20616</code>** [Apache Flink](http://flink.apache.org/) - high-performance runtime, and automatic program optimization.
* **<code>&nbsp;12379</code>** [Metamarkets Druid](http://druid.io/) - framework for real-time analysis of large datasets.
* **<code>&nbsp;&nbsp;6440</code>** [Apache Beam](https://beam.apache.org/) - an unified model and set of language-specific SDKs for defining and executing data processing workflows.
...
* **<code>&nbsp;16558</code>** [Seaweed-FS](https://github.com/chrislusf/seaweedfs) - simple and highly scalable distributed file system.
...
* **<code>&nbsp;25905</code>** [RethinkDB](https://rethinkdb.com/) - document database that supports queries like table joins and group by.
...
* **<code>&nbsp;&nbsp;9026</code>** [ScyllaDB](http://www.scylladb.com/) - column-oriented distributed datastore written in C++, totally compatible with Apache Cassandra.
...
* **<code>&nbsp;13403</code>** [Bolt](https://github.com/boltdb/bolt) - an embedded key-value database for Go.
...
* **<code>&nbsp;&nbsp;3051</code>** [Tarantool](https://github.com/tarantool/tarantool) - an efficient NoSQL database and a Lua application server.
* **<code>&nbsp;&nbsp;2575</code>** [Linkedin Voldemort](http://www.project-voldemort.com/voldemort/) - distributed key/value storage system.
* **<code>&nbsp;&nbsp;1984</code>** [GridDB](https://github.com/griddb/griddb_nosql) - suitable for sensor data stored in a timeseries.
...
* **<code>&nbsp;18923</code>** [DGraph](https://github.com/dgraph-io/dgraph) - A scalable, distributed, low latency, high throughput graph database aimed at providing Google production level scale and throughput, with low enough latency to be serving real time user queries, over terabytes of structured data.
...
* **<code>&nbsp;27058</code>** [ClickHouse](https://clickhouse.yandex/) - an open-source column-oriented database management system that allows generating analytical data reports in real time.
* **<code>&nbsp;&nbsp;1860</code>** [Parquet](http://parquet.apache.org/) - columnar storage format for Hadoop.
...
* **<code>&nbsp;33363</code>** [TiDB](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.
* **<code>&nbsp;26583</code>** [Cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
...
* **<code>&nbsp;20838</code>** [TDengine](https://github.com/taosdata/TDengine/) - a time series database in C utilizing unique features of IoT to improve read/write throughput and reduce space needed to store data
* **<code>&nbsp;12379</code>** [Druid](https://github.com/druid-io/druid/) Column oriented distributed data store ideal for powering interactive applications
* **<code>&nbsp;11418</code>** [Thanos](https://github.com/improbable-eng/thanos) - Thanos is a set of components to create a highly available metric system with unlimited storage capacity using multiple (existing) Prometheus deployments.
* **<code>&nbsp;&nbsp;7934</code>** [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, scalable and resource-effective open-source TSDB compatible with Prometheus. Single-node and cluster versions included
...
* **<code>&nbsp;34968</code>** [Spark Catalyst](https://github.com/apache/spark/tree/master/sql) - is a Query Optimization Framework for Spark and Shark.
* **<code>&nbsp;14441</code>** [Facebook PrestoDB](https://prestodb.io/) - distributed SQL query engine.
* **<code>&nbsp;&nbsp;4822</code>** [Materialize](https://github.com/materializeinc/materialize) - is a streaming database for real-time applications using SQL for queries and supporting a large fraction of PostgreSQL.
* **<code>&nbsp;&nbsp;4650</code>** [Apache Hive](http://hive.apache.org/) - SQL-like data warehouse system for Hadoop.
...
## Data Ingestion
* **<code>&nbsp;12298</code>** [Apache Pulsar](https://github.com/apache/pulsar) - a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
* **<code>&nbsp;11773</code>** [Fluentd](http://www.fluentd.org) - tool to collect events and logs.
* **<code>&nbsp;&nbsp;6114</code>** [redpanda](https://vectorized.io/redpanda) - A Kafka® replacement for mission critical systems; 10x faster. Written in C++.
...
* **<code>&nbsp;&nbsp;3452</code>** [RudderStack](https://github.com/rudderlabs/rudder-server) - an open source customer data infrastructure (segment, mParticle  alternative) written in go.
...
* **<code>&nbsp;&nbsp;9554</code>** [Apache Thrift](http://thrift.apache.org//) - framework to build binary protocols.
...
* **<code>&nbsp;29103</code>** [Apache Airflow](https://github.com/apache/incubator-airflow) - a platform to programmatically author, schedule and monitor workflows.
* **<code>&nbsp;&nbsp;8434</code>** [Azure Data Factory](https://docs.microsoft.com/en-us/azure/data-factory/data-factory-introduction) - cloud-based pipeline orchestration for on-prem, cloud and HDInsight
* **<code>&nbsp;&nbsp;6499</code>** [Dagster](https://github.com/dagster-io/dagster) - a data orchestrator for machine learning, analytics, and ETL.
...
* **<code>171118</code>** [TensorFlow](https://github.com/tensorflow/tensorflow) - Library from Google for machine learning using data flow graphs.
* **<code>&nbsp;57281</code>** [Keras](https://github.com/fchollet/keras) - An intuitive neural net API inspired by Torch that runs atop Theano and Tensorflow.
* **<code>&nbsp;52878</code>** [scikit-learn](https://github.com/scikit-learn/scikit-learn) - scikit-learn: machine learning in Python.
...
* **<code>&nbsp;&nbsp;3952</code>** [Feast](https://github.com/gojek/feast) - A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.
* **<code>&nbsp;&nbsp;2928</code>** [ML Workspace](https://github.com/ml-tooling/ml-workspace) - All-in-one web-based IDE specialized for machine learning and data science.
* **<code>&nbsp;&nbsp;2037</code>** [Mahout](http://mahout.apache.org/) - An Apache-backed machine learning library for Hadoop.
* **<code>&nbsp;&nbsp;1918</code>** [PyTorch Geometric Temporal](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) - a temporal extension library for PyTorch Geometric .
...
* **<code>&nbsp;19203</code>** [Facebook Faiss](https://github.com/facebookresearch/faiss) - is a library for efficient similarity search and clustering of dense vectors. It contains algorithms that search in sets of vectors of any size, up to ones that possibly do not fit in RAM. It also contains supporting code for evaluation and parameter tuning. Faiss is written in C++ with complete wrappers for Python/numpy.
* **<code>&nbsp;10760</code>** [Annoy](https://github.com/spotify/annoy) - is a C++ library with Python bindings to search for points in space that are close to a given query point. It also creates large read-only file-based data structures that are mmapped into memory so that many processes may share the same data.
* **<code>&nbsp;&nbsp;4209</code>** [Vespa](http://vespa.ai/) - is an engine for low-latency computation over large data sets. It stores and indexes your data such that queries, selection and processing over the data can be performed at serving time.
* **<code>&nbsp;&nbsp;3401</code>** [Weaviate](https://github.com/semi-technologies/weaviate) - Weaviate is a GraphQL-based semantic search engine with build-in (word) embeddings.
...
* **<code>&nbsp;31831</code>** [LevelDB](https://github.com/google/leveldb) - a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* **<code>&nbsp;24501</code>** [RocksDB](http://rocksdb.org/) - embeddable persistent key-value store for fast storage based on LevelDB.
...
* **<code>&nbsp;31383</code>** [Metabase](https://github.com/metabase/metabase) - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
...
* **<code>104354</code>** [D3](https://d3js.org/) - javaScript library for manipulating documents.
* **<code>&nbsp;54134</code>** [Echarts](https://github.com/ecomfe/echarts) - Baidus enterprise charts.
* **<code>&nbsp;50472</code>** [Superset](https://github.com/apache/incubator-superset) - a data exploration platform designed to be visual, intuitive and interactive, making it easy to slice, dice and visualize data and perform analytics at the speed of thought.
* **<code>&nbsp;22590</code>** [Redash](https://github.com/getredash/redash) - open-source platform to query and visualize data.
* **<code>&nbsp;18077</code>** [Dash](https://github.com/plotly/dash) - Analytical Web Apps for Python, R, Julia, and Jupyter. Built on top of plotly, no JS required
...
* **<code>&nbsp;16856</code>** [Matplotlib](https://github.com/matplotlib/matplotlib) - plotting with Python.
* **<code>&nbsp;15687</code>** [IPython](http://ipython.org/) - provides a rich architecture for interactive computing.
...
* **<code>&nbsp;14620</code>** [Frappe Charts](https://frappe.io/charts) - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
* **<code>&nbsp;10404</code>** [Sigma.js](https://github.com/jacomyal/sigma.js) - JavaScript library dedicated to graph drawing.
* **<code>&nbsp;10217</code>** [Vega](https://github.com/vega/vega) - a visualization grammar.
...
* **<code>&nbsp;&nbsp;4909</code>** [Shiny](http://shiny.rstudio.com/) - a web application framework for R.
