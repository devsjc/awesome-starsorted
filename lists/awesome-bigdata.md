...
* **<code>&nbsp;&nbsp;6123</code>** [Pachyderm](http://pachyderm.io/) - Pachyderm is a data storage platform built on Docker and Kubernetes to provide reproducible data processing and analysis.
* **<code>&nbsp;&nbsp;3534</code>** [Polyaxon](https://github.com/polyaxon/polyaxon) - A platform for reproducible and scalable machine learning and deep learning.
* **<code>&nbsp;&nbsp;1036</code>** [Bistro](https://github.com/facebook/bistro) - general-purpose data processing engine for both batch and stream analytics. It is based on a novel data model, which represents data via *functions* and processes data via *column operations* as opposed to having only set operations in conventional approaches like MapReduce or SQL.
...
* **<code>&nbsp;&nbsp;&nbsp;283</code>** [Tigon](https://github.com/caskdata/tigon) - High Throughput Real-time Stream Processing Framework.
...
* **<code>&nbsp;39111</code>** [Apache Spark Streaming](https://spark.apache.org/docs/latest/streaming-programming-guide.html) - framework for stream processing, part of Spark.
* **<code>&nbsp;39111</code>** [Apache Spark](http://spark.apache.org/) - framework for in-memory cluster computing.
* **<code>&nbsp;32641</code>** [Ray](https://github.com/ray-project/ray) - A fast and simple framework for building and running distributed applications. 
* **<code>&nbsp;23672</code>** [Apache Flink](http://flink.apache.org/) - high-performance runtime, and automatic program optimization.
* **<code>&nbsp;13355</code>** [Metamarkets Druid](http://druid.io/) - framework for real-time analysis of large datasets.
* **<code>&nbsp;&nbsp;7725</code>** [Apache Beam](https://beam.apache.org/) - an unified model and set of language-specific SDKs for defining and executing data processing workflows.
...
* **<code>&nbsp;&nbsp;3489</code>** [Twitter Scalding](https://github.com/twitter/scalding) - Scala library for Map Reduce jobs, built on Cascading.
...
* **<code>&nbsp;22030</code>** [Seaweed-FS](https://github.com/chrislusf/seaweedfs) - simple and highly scalable distributed file system.
* **<code>&nbsp;&nbsp;2854</code>** [Baidu File System](https://github.com/baidu/bfs) - distributed filesystem.
* **<code>&nbsp;&nbsp;1833</code>** [Apache Kudu](http://kudu.apache.org/) - Hadoop's storage layer to enable fast analytics on fast data.
* **<code>&nbsp;&nbsp;1737</code>** [Ambry](https://github.com/linkedin/ambry) - a distributed object store that supports storage of trillion of small immutable objects as well as billions of large objects.
* **<code>&nbsp;&nbsp;1630</code>** [Disco DDFS](http://disco.readthedocs.org/en/latest/howto/ddfs.html) - distributed filesystem.
* **<code>&nbsp;&nbsp;1292</code>** [Tahoe-LAFS](https://www.tahoe-lafs.org/trac/tahoe-lafs) - decentralized cloud storage system.
...
* **<code>&nbsp;&nbsp;2524</code>** [Pilosa](https://github.com/pilosa/pilosa) Open source distributed bitmap index that dramatically accelerates queries across multiple, massive data sets. 

## Document Data Model

* **<code>&nbsp;26657</code>** [RethinkDB](https://rethinkdb.com/) - document database that supports queries like table joins and group by.
* **<code>&nbsp;&nbsp;4026</code>** [Crate Data](https://crate.io/) - is an open source massively scalable data store. It requires zero administration.
* **<code>&nbsp;&nbsp;3507</code>** [RavenDB](https://ravendb.net/) - A transactional, open-source Document Database.
...
* **<code>&nbsp;13111</code>** [ScyllaDB](http://www.scylladb.com/) - column-oriented distributed datastore written in C++, totally compatible with Apache Cassandra.
* **<code>&nbsp;&nbsp;5182</code>** [Apache HBase](http://hbase.apache.org/) - column-oriented distributed datastore, inspired by BigTable.
* **<code>&nbsp;&nbsp;1884</code>** [Baidu Tera](https://github.com/baidu/tera) - an Internet-scale database, inspired by BigTable.
* **<code>&nbsp;&nbsp;1056</code>** [Apache Accumulo](http://accumulo.apache.org/) - distributed key/value store, built on Hadoop.
...
* **<code>&nbsp;14868</code>** [TiKV](https://github.com/pingcap/tikv) - a distributed key-value database powered by Rust and inspired by Google Spanner and HBase.
* **<code>&nbsp;14108</code>** [Bolt](https://github.com/boltdb/bolt) - an embedded key-value database for Go.
* **<code>&nbsp;13661</code>** [Badger](https://open.dgraph.io/post/badger/) - a fast, simple, efficient, and persistent key-value store written natively in Go.
* **<code>&nbsp;&nbsp;9029</code>** [Tile38](https://github.com/tidwall/tile38) - a geolocation data store, spatial index, and realtime geofence, supporting a variety of object types including latitude/longitude points, bounding boxes, XYZ tiles, Geohashes, and GeoJSON
* **<code>&nbsp;&nbsp;4739</code>** [Ignite](https://ignite.apache.org/index.html) - is an in-memory key-value data store providing full SQL-compliant data access that can optionally be backed by disk storage.
* **<code>&nbsp;&nbsp;4482</code>** [BuntDB](https://github.com/tidwall/buntdb) - a fast, embeddable, in-memory key/value database for Go with custom indexing and geospatial support.
* **<code>&nbsp;&nbsp;3928</code>** [Riak](https://github.com/basho/riak) - a decentralized datastore.
* **<code>&nbsp;&nbsp;3374</code>** [Tarantool](https://github.com/tarantool/tarantool) - an efficient NoSQL database and a Lua application server.
* **<code>&nbsp;&nbsp;2633</code>** [Linkedin Voldemort](http://www.project-voldemort.com/voldemort/) - distributed key/value storage system.
* **<code>&nbsp;&nbsp;2355</code>** [GridDB](https://github.com/griddb/griddb_nosql) - suitable for sensor data stored in a timeseries.
...
* **<code>&nbsp;&nbsp;&nbsp;557</code>** [ElephantDB](https://github.com/nathanmarz/elephantdb) - Distributed database specialized in exporting data from Hadoop.
...
* **<code>&nbsp;&nbsp;&nbsp;418</code>** [Graviton](https://github.com/deroproject/graviton) - a simple, fast, versioned, authenticated, embeddable key-value store database in pure Go(lang).
...
* **<code>&nbsp;20255</code>** [DGraph](https://github.com/dgraph-io/dgraph) - A scalable, distributed, low latency, high throughput graph database aimed at providing Google production level scale and throughput, with low enough latency to be serving real time user queries, over terabytes of structured data.
* **<code>&nbsp;14815</code>** [Google Cayley](https://github.com/cayleygraph/cayley) - open-source graph database.
* **<code>&nbsp;&nbsp;5229</code>** [JanusGraph](http://janusgraph.org) - open-source, distributed graph database
* **<code>&nbsp;&nbsp;1945</code>** [Gremlin](https://github.com/tinkerpop/gremlin) - graph traversal Language.
* **<code>&nbsp;&nbsp;1760</code>** [GCHQ Gaffer](https://github.com/gchq/Gaffer) - Gaffer by GCHQ is a framework that makes it easy to store large-scale graphs in which the nodes and edges have statistics.
...
* **<code>&nbsp;&nbsp;&nbsp;&nbsp;25</code>** [Intel GraphBuilder](https://01.org/graphbuilder/) - tools to construct large-scale graphs on top of Hadoop.
...
* **<code>&nbsp;&nbsp;2194</code>** [Microsoft Graph Engine](https://github.com/Microsoft/GraphEngine) - a distributed in-memory data processing engine, underpinned by a strongly-typed in-memory key-value store and a general distributed computation engine.
...
* **<code>&nbsp;36193</code>** [ClickHouse](https://clickhouse.yandex/) - an open-source column-oriented database management system that allows generating analytical data reports in real time.
* **<code>&nbsp;&nbsp;2525</code>** [Parquet](http://parquet.apache.org/) - columnar storage format for Hadoop.
* **<code>&nbsp;&nbsp;1597</code>** [LocustDB](https://github.com/cswinter/LocustDB) - an experimental analytics database aiming to set a new standard for query performance on commodity hardware. 
...
* **<code>&nbsp;&nbsp;8717</code>** [yugabyteDB](https://github.com/YugaByte/yugabyte-db) - open source, high-performance, distributed SQL database compatible with PostgreSQL.
...
* **<code>&nbsp;&nbsp;1336</code>** [Comdb2](https://github.com/bloomberg/comdb2) - a clustered RDBMS built on optimistic concurrency control techniques.
* **<code>&nbsp;&nbsp;1081</code>** [Bedrock](http://bedrockdb.com/) - a simple, modular, networked and distributed transaction layer built atop SQLite.
* **<code>&nbsp;&nbsp;&nbsp;889</code>** [BayesDB](https://github.com/probcomp/BayesDB) - statistic oriented SQL database.
* **<code>&nbsp;&nbsp;&nbsp;722</code>** [SymmetricDS](http://www.symmetricds.org/) - open source software for both file and database synchronization.
* **<code>&nbsp;&nbsp;&nbsp;562</code>** [H-Store](http://hstore.cs.brown.edu/) - is an experimental main-memory, parallel database management system that is optimized for on-line transaction processing (OLTP) applications.
...
* **<code>&nbsp;23135</code>** [TDengine](https://github.com/taosdata/TDengine/) - a time series database in C utilizing unique features of IoT to improve read/write throughput and reduce space needed to store data
* **<code>&nbsp;14192</code>** [QuestDB](https://questdb.io/) - high-performance, open-source SQL database for applications in financial services, IoT, machine learning, DevOps and observability.
* **<code>&nbsp;13355</code>** [Druid](https://github.com/druid-io/druid/) Column oriented distributed data store ideal for powering interactive applications
* **<code>&nbsp;12842</code>** [Thanos](https://github.com/improbable-eng/thanos) - Thanos is a set of components to create a highly available metric system with unlimited storage capacity using multiple (existing) Prometheus deployments.
* **<code>&nbsp;11662</code>** [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, scalable and resource-effective open-source TSDB compatible with Prometheus. Single-node and cluster versions included
* **<code>&nbsp;&nbsp;4982</code>** [OpenTSDB](http://opentsdb.net) - distributed time series database on top of HBase.
...
* **<code>&nbsp;&nbsp;&nbsp;499</code>** [SiriDB](https://github.com/transceptor-technology/siridb-server) Highly-scalable, robust and fast, open source time series database with cluster functionality.
...
* **<code>&nbsp;&nbsp;&nbsp;&nbsp;25</code>** [InfluxDB](https://www.influxdata.com/) - a time series database with optimised IO and queries, supports pgsql and influx wire protocols.
...
* **<code>&nbsp;39111</code>** [Spark Catalyst](https://github.com/apache/spark/tree/master/sql) - is a Query Optimization Framework for Spark and Shark.
* **<code>&nbsp;15833</code>** [Facebook PrestoDB](https://prestodb.io/) - distributed SQL query engine.
* **<code>&nbsp;&nbsp;5697</code>** [Materialize](https://github.com/materializeinc/materialize) - is a streaming database for real-time applications using SQL for queries and supporting a large fraction of PostgreSQL.
* **<code>&nbsp;&nbsp;5461</code>** [Apache Hive](http://hive.apache.org/) - SQL-like data warehouse system for Hadoop.
...
## Data Ingestion
* **<code>&nbsp;14039</code>** [Apache Pulsar](https://github.com/apache/pulsar) - a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
* **<code>&nbsp;12761</code>** [Fluentd](http://www.fluentd.org) - tool to collect events and logs.
* **<code>&nbsp;&nbsp;9279</code>** [redpanda](https://vectorized.io/redpanda) - A Kafka® replacement for mission critical systems; 10x faster. Written in C++.
* **<code>&nbsp;&nbsp;4665</code>** [Apache NiFi](https://nifi.apache.org/) - Apache NiFi is an integrated data logistics platform for automating the movement of data between disparate systems.
* **<code>&nbsp;&nbsp;4030</code>** [RudderStack](https://github.com/rudderlabs/rudder-server) - an open source customer data infrastructure (segment, mParticle  alternative) written in go.
* **<code>&nbsp;&nbsp;3924</code>** [Facebook Scribe](https://github.com/facebookarchive/scribe) - streamed log data aggregator.
* **<code>&nbsp;&nbsp;3396</code>** [Heka](https://github.com/mozilla-services/heka) - open source stream processing software system.
* **<code>&nbsp;&nbsp;2209</code>** [Linkedin Gobblin](https://github.com/linkedin/gobblin) - linkedin's universal data ingestion framework.
* **<code>&nbsp;&nbsp;1841</code>** [Pinterest Secor](https://github.com/pinterest/secor) - is a service implementing Kafka log persistance.
* **<code>&nbsp;&nbsp;&nbsp;968</code>** [Apache Sqoop](http://sqoop.apache.org/) - tool to transfer data between Hadoop and a structured datastore.
* **<code>&nbsp;&nbsp;&nbsp;792</code>** [Netflix Suro](https://github.com/Netflix/suro) - log agregattor like Storm and Samza based on Chukwa.
...
* **<code>&nbsp;&nbsp;&nbsp;681</code>** [Gazette](https://github.com/gazette/core) - Distributed streaming infrastructure built on cloud storage which makes it easy to mix and match batch and streaming paradigms.
* **<code>&nbsp;&nbsp;&nbsp;516</code>** [Zilla](https://github.com/aklivity/zilla) - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* **<code>&nbsp;17613</code>** [Spotify Luigi](https://github.com/spotify/luigi) - a Python package for building complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization, handling failures, command line integration, and much more.
* **<code>&nbsp;13008</code>** [Akka Toolkit](http://akka.io/) - runtime for distributed, and fault tolerant event-driven applications on the JVM.
* **<code>&nbsp;10281</code>** [Apache Thrift](http://thrift.apache.org//) - framework to build binary protocols.
* **<code>&nbsp;&nbsp;5840</code>** [Serf](https://www.serf.io/) - decentralized solution for service discovery and orchestration.
* **<code>&nbsp;&nbsp;2861</code>** [Apache Avro](http://avro.apache.org/) - data serialization system.
* **<code>&nbsp;&nbsp;2102</code>** [OpenMPI](https://www.open-mpi.org/) - message passing framework.
...
* **<code>&nbsp;35840</code>** [Apache Airflow](https://github.com/apache/incubator-airflow) - a platform to programmatically author, schedule and monitor workflows.
* **<code>&nbsp;10951</code>** [Dagster](https://github.com/dagster-io/dagster) - a data orchestrator for machine learning, analytics, and ETL.
* **<code>&nbsp;10163</code>** [Azure Data Factory](https://docs.microsoft.com/en-us/azure/data-factory/data-factory-introduction) - cloud-based pipeline orchestration for on-prem, cloud and HDInsight
* **<code>&nbsp;&nbsp;4435</code>** [Linkedin Azkaban](https://azkaban.github.io/) - batch workflow job scheduler.
* **<code>&nbsp;&nbsp;3599</code>** [Cronicle](https://github.com/jhuckaby/Cronicle) - Distributed, easy to install, NodeJS based, task scheduler
...
* **<code>184691</code>** [TensorFlow](https://github.com/tensorflow/tensorflow) - Library from Google for machine learning using data flow graphs.
* **<code>&nbsp;61449</code>** [Keras](https://github.com/fchollet/keras) - An intuitive neural net API inspired by Torch that runs atop Theano and Tensorflow.
* **<code>&nbsp;59162</code>** [scikit-learn](https://github.com/scikit-learn/scikit-learn) - scikit-learn: machine learning in Python.
...
* **<code>&nbsp;10846</code>** [convnetjs](https://github.com/karpathy/convnetjs) - Deep Learning in Javascript. Train Convolutional Neural Networks (or ordinary ones) in your browser.
* **<code>&nbsp;&nbsp;8449</code>** [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit/wiki) - learning system sponsored by Microsoft and Yahoo!.
* **<code>&nbsp;&nbsp;8003</code>** [brain](https://github.com/harthur/brain) - Neural networks in JavaScript.
* **<code>&nbsp;&nbsp;6840</code>** [H2O](https://github.com/h2oai/h2o-3/) - statistical, machine learning and math runtime with Hadoop. R and Python.
...
* **<code>&nbsp;&nbsp;5425</code>** [Feast](https://github.com/gojek/feast) - A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.
* **<code>&nbsp;&nbsp;3380</code>** [ML Workspace](https://github.com/ml-tooling/ml-workspace) - All-in-one web-based IDE specialized for machine learning and data science.
* **<code>&nbsp;&nbsp;2589</code>** [PyTorch Geometric Temporal](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) - a temporal extension library for PyTorch Geometric .
* **<code>&nbsp;&nbsp;2131</code>** [Mahout](http://mahout.apache.org/) - An Apache-backed machine learning library for Hadoop.
* **<code>&nbsp;&nbsp;2123</code>** [Karate Club](https://github.com/benedekrozemberczki/karateclub) - An unsupervised machine learning library for graph structured data. Python
...
* **<code>&nbsp;&nbsp;&nbsp;697</code>** [Little Ball of Fur](https://github.com/benedekrozemberczki/littleballoffur) - A subsampling library for graph structured data. Python
* **<code>&nbsp;&nbsp;&nbsp;606</code>** [MOA](http://moa.cms.waikato.ac.nz) - MOA performs big data stream mining in real time, and large scale machine learning.
* **<code>&nbsp;&nbsp;&nbsp;590</code>** [Spark MLlib](http://spark.apache.org/docs/0.9.0/mllib-guide.html) - a Spark implementation of some common machine learning (ML) functionality.
...
* **<code>&nbsp;&nbsp;&nbsp;215</code>** [Shapley](https://github.com/benedekrozemberczki/shapley) - A data-driven framework to quantify the value of classifiers in a machine learning ensemble. 
...
* **<code>&nbsp;&nbsp;&nbsp;&nbsp;48</code>** [UCSB](https://github.com/unum-cloud/ucsb) - extended Yahoo Cloud Serving Benchmark for NoSQL databases.
...
## Security
* **<code>&nbsp;&nbsp;&nbsp;883</code>** [Apache Ranger](http://ranger.apache.org/) - Central security admin & fine-grained authorization for Hadoop
* **<code>&nbsp;&nbsp;&nbsp;407</code>** [Apache Eagle](http://eagle.apache.org/) - real time monitoring solution
...
* **<code>&nbsp;&nbsp;3279</code>** [Linkis](https://github.com/WeBankFinTech/Linkis) - Linkis helps easily connect to various back-end computation/storage engines.
* **<code>&nbsp;&nbsp;2129</code>** [Apache Ambari](http://ambari.apache.org/) - operational framework for Hadoop mangement.
* **<code>&nbsp;&nbsp;1151</code>** [Cloudera HUE](http://gethue.com/) - web application for interacting with Hadoop.
* **<code>&nbsp;&nbsp;&nbsp;602</code>** [Apache Bigtop](http://bigtop.apache.org//) - system deployment framework for the Hadoop ecosystem.
...
* **<code>&nbsp;&nbsp;7977</code>** [ElastAert](https://github.com/Yelp/elastalert) - ElastAlert is a simple framework for alerting on anomalies, spikes, or other patterns of interest from data in ElasticSearch.
* **<code>&nbsp;&nbsp;6799</code>** [Snowplow](https://github.com/snowplow/snowplow) - enterprise-strength web and event analytics, powered by Hadoop, Kinesis, Redshift and Postgres.
* **<code>&nbsp;&nbsp;3628</code>** [Kylin](http://kylin.apache.org/) - open source Distributed Analytics Engine from eBay.
* **<code>&nbsp;&nbsp;3418</code>** [Atlas](https://github.com/Netflix/atlas) - a backend for managing dimensional time series data.
* **<code>&nbsp;&nbsp;2870</code>** [Apache Nutch](http://nutch.apache.org/) - open source web crawler.
* **<code>&nbsp;&nbsp;2301</code>** [Kapacitor](https://github.com/influxdata/kapacitor) - an open source framework for processing, monitoring, and alerting on time series data.
...
* **<code>&nbsp;&nbsp;1018</code>** [HASH](https://hash.ai) - open source simulation and visualization platform.
...
* **<code>&nbsp;&nbsp;&nbsp;844</code>** [Apache Metron](http://metron.apache.org/) - a platform that integrates a variety of open source big data technologies in order to offer a centralized tool for security monitoring and analysis.
* **<code>&nbsp;&nbsp;&nbsp;807</code>** [Hermes](https://github.com/allegro/hermes) - asynchronous message broker built on top of Kafka.
...
* **<code>&nbsp;&nbsp;&nbsp;437</code>** [Eclipse BIRT](http://www.eclipse.org/birt/) - Eclipse-based reporting system.
...
* **<code>&nbsp;&nbsp;&nbsp;308</code>** [Substation](https://github.com/brexhq/substation) - Substation is a cloud native data pipeline and transformation toolkit written in Go.
...
* **<code>&nbsp;29974</code>** [Facebook Faiss](https://github.com/facebookresearch/faiss) - is a library for efficient similarity search and clustering of dense vectors. It contains algorithms that search in sets of vectors of any size, up to ones that possibly do not fit in RAM. It also contains supporting code for evaluation and parameter tuning. Faiss is written in C++ with complete wrappers for Python/numpy.
* **<code>&nbsp;13010</code>** [Annoy](https://github.com/spotify/annoy) - is a C++ library with Python bindings to search for points in space that are close to a given query point. It also creates large read-only file-based data structures that are mmapped into memory so that many processes may share the same data.
* **<code>&nbsp;10522</code>** [Weaviate](https://github.com/semi-technologies/weaviate) - Weaviate is a GraphQL-based semantic search engine with build-in (word) embeddings.
* **<code>&nbsp;&nbsp;5520</code>** [Vespa](http://vespa.ai/) - is an engine for low-latency computation over large data sets. It stores and indexes your data such that queries, selection and processing over the data can be performed at serving time.
* **<code>&nbsp;&nbsp;1709</code>** [Elassandra](https://github.com/strapdata/elassandra) - is a fork of Elasticsearch modified to run on top of Apache Cassandra in a scalable and resilient peer-to-peer architecture.
* **<code>&nbsp;&nbsp;&nbsp;562</code>** [LinkedIn Cleo](https://github.com/linkedin/cleo) - is a flexible software library for enabling rapid development of partial, out-of-order and real-time typeahead search.
...
* **<code>&nbsp;17223</code>** [TimescaleDB](http://www.timescale.com/) - An open-source time-series database optimized for fast ingest and complex queries
...
* **<code>&nbsp;12107</code>** [Twemproxy](https://github.com/twitter/twemproxy) - A fast, light-weight proxy for memcached and redis.
...
* **<code>&nbsp;35944</code>** [LevelDB](https://github.com/google/leveldb) - a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* **<code>&nbsp;28062</code>** [RocksDB](http://rocksdb.org/) - embeddable persistent key-value store for fast storage based on LevelDB.
* **<code>&nbsp;&nbsp;&nbsp;302</code>** [HanoiDB](https://github.com/krestenkrab/hanoidb) - Erlang LSM BTree Storage.
...
* **<code>&nbsp;37680</code>** [Metabase](https://github.com/metabase/metabase) - The simplest, fastest way to get business intelligence and analytics to everyone in your company.
* **<code>&nbsp;25780</code>** [Redash](https://redash.io/) - Open source business intelligence platform, supporting multiple data sources and planned queries.
* **<code>&nbsp;&nbsp;4452</code>** [Blazer](https://github.com/ankane/blazer) - business intelligence made simple.
...
* **<code>&nbsp;61133</code>** [Superset](https://github.com/apache/incubator-superset) - a data exploration platform designed to be visual, intuitive and interactive, making it easy to slice, dice and visualize data and perform analytics at the speed of thought.
* **<code>&nbsp;59913</code>** [Echarts](https://github.com/ecomfe/echarts) - Baidus enterprise charts.
* **<code>&nbsp;25780</code>** [Redash](https://github.com/getredash/redash) - open-source platform to query and visualize data.
* **<code>&nbsp;21043</code>** [Dash](https://github.com/plotly/dash) - Analytical Web Apps for Python, R, Julia, and Jupyter. Built on top of plotly, no JS required
* **<code>&nbsp;19805</code>** [Matplotlib](https://github.com/matplotlib/matplotlib) - plotting with Python.
* **<code>&nbsp;19146</code>** [Bokeh](http://bokeh.pydata.org/en/latest/) - A powerful Python interactive visualization library that targets modern web browsers for presentation, with the goal of providing elegant, concise construction of novel graphics in the style of D3.js, but also delivering this capability with high-performance interactivity over very large or streaming datasets.
* **<code>&nbsp;16795</code>** [Plotly.js](https://github.com/plotly/plotly.js) The open source javascript graphing library that powers plotly.
* **<code>&nbsp;16215</code>** [IPython](http://ipython.org/) - provides a rich architecture for interactive computing.
* **<code>&nbsp;11953</code>** [Highcharts](https://www.highcharts.com/) - simple and flexible charting API.
* **<code>&nbsp;11172</code>** [Sigma.js](https://github.com/jacomyal/sigma.js) - JavaScript library dedicated to graph drawing.
* **<code>&nbsp;11018</code>** [Vega](https://github.com/vega/vega) - a visualization grammar.
* **<code>&nbsp;&nbsp;9340</code>** [C3](http://c3js.org/) - D3-based reusable chart library
* **<code>&nbsp;&nbsp;7219</code>** [NVD3](http://nvd3.org/) - chart components for d3.js.
* **<code>&nbsp;&nbsp;6433</code>** [Freeboard](https://github.com/Freeboard/freeboard) - pen source real-time dashboard builder for IOT and other web mashups.
* **<code>&nbsp;&nbsp;5796</code>** [Gephi](https://github.com/gephi/gephi) - An award-winning open-source platform for visualizing and manipulating large graphs and network connections. It's like Photoshop, but for graphs. Available for Windows and Mac OS X.
* **<code>&nbsp;&nbsp;5334</code>** [Shiny](http://shiny.rstudio.com/) - a web application framework for R.
* **<code>&nbsp;&nbsp;4939</code>** [Cubism](https://github.com/square/cubism) - JavaScript library for time series visualization.
* **<code>&nbsp;&nbsp;4218</code>** [Peity](https://github.com/benpickles/peity) - Progressive SVG bar, line and pie charts.
* **<code>&nbsp;&nbsp;3024</code>** [DataSphere Studio](https://github.com/WeBankFinTech/DataSphereStudio) - one-stop data application development management portal.
* **<code>&nbsp;&nbsp;2763</code>** [Airpal](https://github.com/airbnb/airpal) - Web UI for PrestoDB.
* **<code>&nbsp;&nbsp;2745</code>** [CartoDB](https://github.com/CartoDB/cartodb) - open-source or freemium hosting for geospatial databases with powerful front-end editing capabilities and a robust API.
* **<code>&nbsp;&nbsp;2658</code>** [Arbor](https://github.com/samizdatco/arbor) - graph visualization library using web workers and jQuery.
* **<code>&nbsp;&nbsp;2188</code>** [Recline](https://github.com/okfn/recline) - simple but powerful library for building data applications in pure Javascript and HTML.
* **<code>&nbsp;&nbsp;2047</code>** [Chart.js](http://www.chartjs.org/) - open source HTML5 Charts visualizations.
...
* **<code>&nbsp;&nbsp;&nbsp;568</code>** [Cytoscape](http://cytoscape.github.io/) - JavaScript library for visualizing complex networks.
* **<code>&nbsp;&nbsp;&nbsp;412</code>** [Zeppelin](https://github.com/ZEPL/zeppelin) - a notebook-style collaborative data analysis.
* **<code>&nbsp;&nbsp;&nbsp;271</code>** [Zing Charts](https://www.zingchart.com/) - JavaScript charting library for big data.
* **<code>&nbsp;&nbsp;&nbsp;246</code>** [Frappe Charts](https://frappe.io/charts) - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
...
* **<code>&nbsp;&nbsp;1160</code>** [NoSQL Comparison](https://kkovacs.eu/cassandra-vs-mongodb-vs-couchdb-vs-redis) - Cassandra vs MongoDB vs CouchDB vs Redis vs Riak vs HBase vs Couchbase vs Neo4j vs Hypertable vs ElasticSearch vs Accumulo vs VoltDB vs Scalaris comparison.
* **<code>&nbsp;&nbsp;&nbsp;617</code>** [Monitoring Kafka performance](https://www.datadoghq.com/blog/monitoring-kafka-performance-metrics?ref=awesome) - Guide to monitoring Apache Kafka, including native methods for metrics collection.
* **<code>&nbsp;&nbsp;&nbsp;617</code>** [Monitoring Hadoop performance](https://www.datadoghq.com/blog/monitor-hadoop-metrics?ref=awesome) - Guide to monitoring Hadoop, with an overview of Hadoop architecture, and native methods for metrics collection.
* **<code>&nbsp;&nbsp;&nbsp;617</code>** [Monitoring Cassandra performance](https://www.datadoghq.com/blog/how-to-monitor-cassandra-performance-metrics/?ref=awesome) - Guide to monitoring Cassandra, including native methods for metrics collection.
...
* **<code>&nbsp;&nbsp;&nbsp;&nbsp;93</code>** [Grokking Streaming Systems](https://www.manning.com/books/grokking-streaming-systems) - Grokking Streaming Systems helps you unravel what streaming systems are, how they work, and whether they’re right for your business. Written to be tool-agnostic, you’ll be able to apply what you learn no matter which framework you choose.
...
#### Distributed systems
* **<code>&nbsp;&nbsp;2539</code>** [Distributed Systems for fun and profit](http://book.mixu.net/distsys/) – Theory of distributed systems. Include parts about time and ordering, replication and impossibility results.

#### Graph Based approach
* **<code>&nbsp;&nbsp;&nbsp;&nbsp;67</code>** [Graph-Powered Machine Learning](https://www.manning.com/books/graph-powered-machine-learning) - Alessandro Negro. Combine graph theory and models to improve machine learning projects
